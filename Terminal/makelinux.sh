...
g++ -o Build/jb  -std=gnu++17 -L/usr/local/lib/ -I /usr/local/include -I /usr/local/speedie/Library/CppLib -w -Wno-return-type-c-linkage -lc++ -Os -ffast-math -flto -D TARGET_UNIX=1 -D __SPEEDIE__=1 -g -ljeebox  jb.cpp
echo "Compiling xml.cpp"
g++ -o Build/xml  -std=gnu++17 -L/usr/local/lib/ -I /usr/local/include -I /usr/local/speedie/Library/CppLib -w -Wno-return-type-c-linkage -lc++ -Os -ffast-math -flto -D TARGET_UNIX=1 -D __SPEEDIE__=1 -g -ljeebox  xml.cpp
echo "Compiling test.cpp"
g++ -o Build/test  -std=gnu++17 -L/usr/local/lib/ -I /usr/local/include -I /usr/local/speedie/Library/CppLib -w -Wno-return-type-c-linkage -lc++ -Os -ffast-math -flto -D TARGET_UNIX=1 -D __SPEEDIE__=1 -g -ljeebox  test.cpp
echo "Compiling users.cpp"
g++ -o Build/users  -std=gnu++17 -L/usr/local/lib/ -I /usr/local/include -I /usr/local/speedie/Library/CppLib -w -Wno-return-type-c-linkage -lc++ -Os -ffast-math -flto -D TARGET_UNIX=1 -D __SPEEDIE__=1 -g -ljeebox  users.cpp
