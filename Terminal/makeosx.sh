...
set -e
# Override clang++ by exporting CXX.
CXX="${CXX:-clang++}"
...
$CXX -o Build/jb  -std=gnu++20 -L/usr/local/lib/ -I /usr/local/include -I /usr/local/speedie/Library/CppLib -w -Wno-return-type-c-linkage -Os -ffast-math -D TARGET_UNIX=1 -D __SPEEDIE__=1 -lc++ -g -ljeebox  jb.cpp
chmod 775 Build/jb
chown $U Build/jb

echo "Compiling xml.cpp"
$CXX -o Build/xml  -std=gnu++20 -L/usr/local/lib/ -I /usr/local/include -I /usr/local/speedie/Library/CppLib -w -Wno-return-type-c-linkage -Os -ffast-math -D TARGET_UNIX=1 -D __SPEEDIE__=1 -lc++ -g -ljeebox  xml.cpp
chmod 775 Build/xml
chown $U Build/xml

echo "Compiling test.cpp"
$CXX -o Build/test  -std=gnu++20 -L/usr/local/lib/ -I /usr/local/include -I /usr/local/speedie/Library/CppLib -w -Wno-return-type-c-linkage -Os -ffast-math -D TARGET_UNIX=1 -D __SPEEDIE__=1 -lc++ -g -ljeebox  test.cpp
chmod 775 Build/test
chown $U Build/test

echo "Compiling users.cpp"
$CXX -o Build/users  -std=gnu++20 -L/usr/local/lib/ -I /usr/local/include -I /usr/local/speedie/Library/CppLib -w -Wno-return-type-c-linkage -Os -ffast-math -D TARGET_UNIX=1 -D __SPEEDIE__=1 -lc++ -g -ljeebox  users.cpp
