...
Array* JB_App__args() {
	return ({
		Array* _X = JB__App_OldArgs;
		if ((!JB_Array_SyntaxCast(_X))) {
			_X = JB_App__args_();
			JB_SetRef(JB__App_OldArgs, _X);
		}
		 _X;
	});
}
...
Array* JB_App__args_() {
	Array* rz = ((Array*)JB_Array__New0());
	{
		...
		while (_if0 < JB_Array_Size(_LoopSrcf1)) {
			JB_StringC* R = ((JB_StringC*)JB_Array_Value(_LoopSrcf1, _if0));
			if (JB_Object_HasArgName(R, JB_LUB[0])) {
				JB_Array_SyntaxAppend(rz, R);
			}
			_if0++;
		};
	}
...
int JB_Main() {
	//visible;
	Person* P = JB_Incr(App_Person__NewAuto(12, JB_LUB[2]));
	(App_Person_ageSet(P, -2));
	JB_Decr(P);
	Array* x = JB_Incr((JB_Array__New(0)));
	JB_Array_SyntaxAppend(x, JB_LUB[3]);
	JB_Array_SyntaxAppend(x, JB_LUB[4]);
	JB_Array_SyntaxAppend(x, JB_LUB[5]);
	if (JB_Array_SyntaxEquals(x, 3, false)) {
		FastString* _fsf0 = JB_Incr(JB_FS__New());
		(JB_Array_Render(x, _fsf0));
		JB_FS_AppendString(_fsf0, JB_LUB[6]);
		JB_String* _tmPf7 = JB_Incr(JB_FS_GetResult(_fsf0));
		JB_Decr(_fsf0);
		JB_PrintLine(_tmPf7);
		JB_Decr(_tmPf7);
	}
	JB_Decr(x);
	JB_String* H = JB_Incr(JB_LUB[7]);
	if (JB_Str_EqualsInt(H, 5, false)) {
		FastString* _fsf1 = JB_Incr(JB_FS__New());
		JB_FS_AppendByte(_fsf1, '\'');
		JB_FS_AppendString(_fsf1, H);
		JB_FS_AppendString(_fsf1, JB_LUB[8]);
	...
	JB_Decr(H);
	Message* L = JB_Incr(JB_Str_Parse(JB_LUB[9], JB_SyxArg));
	if (JB_Tree_SyntaxEquals(L, 4, false)) {
		FastString* _fsf2 = JB_Incr(JB_FS__New());
		JB_FS_AppendString(_fsf2, JB_LUB[10]);
		JB_FS_SyntaxAppend(_fsf2, L);
		JB_FS_AppendString(_fsf2, JB_LUB[11]);
	...
	int z = 0;
	{
		int i = 0;
		while (i < 10) {
			if (JB_int_OperatorIsa(i, 2)) {
				FastString* _fsf3 = JB_Incr(JB_FS__New());
				JB_FS_AppendInt32(_fsf3, i);
				JB_FS_AppendString(_fsf3, JB_LUB[12]);
				JB_String* _tmPf10 = JB_Incr(JB_FS_GetResult(_fsf3));
				JB_Decr(_fsf3);
				JB_PrintLine(_tmPf10);
				JB_Decr(_tmPf10);
				z = JB_int_SyntaxAccessSet(z, i, true);
			}
			 else {
				FastString* _fsf4 = JB_Incr(JB_FS__New());
				JB_FS_AppendInt32(_fsf4, i);
				JB_FS_AppendString(_fsf4, JB_LUB[13]);
				JB_String* _tmPf11 = JB_Incr(JB_FS_GetResult(_fsf4));
				JB_Decr(_fsf4);
	...
	;
	FastString* _fsf5 = JB_Incr(JB_FS__New());
	JB_FS_AppendString(_fsf5, JB_LUB[14]);
	JB_FS_AppendInt32(_fsf5, z);
	JB_String* _tmPf12 = JB_Incr(JB_FS_GetResult(_fsf5));
	JB_Decr(_fsf5);
	JB_PrintLine(_tmPf12);
	JB_Decr(_tmPf12);
	SayerFunction fn = ((SayerFunction)JB_Ternary((JB_Rnd_SyntaxAccess((&JB__Rnd_Shared))) < 0.5f, App_MeSayer, ((SayerFunction)App_SheSayer)));
	Array* _tmPf14 = JB_Incr(JB_App__args());
	JB_String* _tmPf13 = JB_Incr(((JB_String*)JB_Array_Value(_tmPf14, 0)));
	JB_Decr(_tmPf14);
	(fn)(_tmPf13);
	JB_Decr(_tmPf13);
	RPGHero* G = JB_Incr(App_RPGHero__New(JB_LUB[2]));
	DTWrap* _tmPf15 = JB_Incr(((DTWrap*)JB_Dict_ValueStr(JB_DoAction, JB_LUB[15])));
	((Fn_DoAction)JB_Wrap_Value(_tmPf15))(G, JB_LUB[16]);
	JB_Decr(_tmPf15);
	JB_Decr(G);
	JB_Decr(L);
	return 0;
...
int JB_Constants__Init_() {
	{
		...
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[17], JB_LUB[18]));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[19], JB_LUB[20]));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[21], JB_LUB[22]));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[23], JB_LUB[24]));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[25], JB_LUB[26]));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[27], JB_LUB[28]));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[29], JB_LUB[30]));
		(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[31], JB_LUB[32]));
		JB_SetRef(JB__Constants_XML_EscapeStr, (JB_Dict__New()));
		(JB_Dict_ValueSet(JB__Constants_XML_EscapeStr, JB_LUB[33], JB_LUB[34]));
		(JB_Dict_ValueSet(JB__Constants_XML_EscapeStr, JB_LUB[27], JB_LUB[35]));
		(JB_Dict_ValueSet(JB__Constants_XML_EscapeStr, JB_LUB[25], JB_LUB[36]));
		(JB_Dict_ValueSet(JB__Constants_XML_EscapeStr, JB_LUB[37], JB_LUB[38]));
		(JB_Dict_ValueSet(JB__Constants_XML_EscapeStr, JB_LUB[39], JB_LUB[40]));
		JB_SetRef(JB__Constants_JS_EscapeStr, (JB_Dict__New()));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_LUB[41], JB_LUB[42]));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_LUB[43], JB_LUB[44]));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_LUB[19], JB_LUB[20]));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_LUB[21], JB_LUB[22]));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_LUB[23], JB_LUB[24]));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_LUB[25], JB_LUB[26]));
		(JB_Dict_ValueSet(JB__Constants_JS_EscapeStr, JB_LUB[29], JB_LUB[30]));
		JB_SetRef(JB__Constants_CSWordMiddle, JB_Str_UniCS(JB_LUB[45]));
		JB_SetRef(JB__Constants_CSLettersOnly, JB_Str_UniCS(JB_LUB[46]));
		JB_SetRef(JB__Constants_CSWordStart, JB_Str_UniCS(JB_LUB[47]));
		JB_SetRef(JB__Constants_CSNum, JB__Constants_CSWordMiddle);
		JB_SetRef(JB__Constants_CSLine, JB_Str_CharSetWithBool(JB_LUB[48], false));
		JB_SetRef(JB__Constants_CSAfterStatement, JB_Str_CharSetWithBool(JB_LUB[49], false));
		JB_SetRef(JB__Constants_CSLineBlack, JB_Str_CharSetWithBool(JB_LUB[50], false));
		JB_SetRef(JB__Constants_CSWrapSplit, JB_Str_CharSetWithBool(JB_LUB[51], false));
	}
	;
	return 0;
}
...
void JB_Constants__InitConstants() {
	...
	(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[52], JB_LUB[53]));
	...
	(JB_Dict_ValueSet(JB__Constants_EscapeChr, JB_LUB[25], ((JB_String*)nil)));
	(JB_Dict_ValueSet(JB__Constants_EscapeChr, JB_LUB[52], ((JB_String*)nil)));
	(JB_Dict_ValueSet(JB__Constants_UnEscapeStr, JB_LUB[54], ((JB_String*)nil)));
	(JB_Dict_ValueSet(JB__Constants_UnEscapeStr, JB_LUB[29], JB_LUB[0]));
	(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[27], ((JB_String*)nil)));
	...
	(JB_Dict_ValueSet(JB__Constants_EscapeStr, JB_LUB[55], JB_LUB[56]));
}
		...
		if (Extra > 0) {
			if ((Extra == 2) and (JB_int_OperatorIsa(((int)prev->Indent), 4))) {
				...
				if (((bool)(curr->Indent & 1))) {
					return JB_Tk__ErrorAdd(JB_LUB[57], curr->Position);
				}
...
Message* JB_Tk__BarThings(int Start, Syntax Syx) {
	...
	JB__Tk_StopBars = 0;
	if ((!JB_Tk__ExpectEndChar(JB_Tk__NextStart(), JB_LUB[58], true))) {
		JB_Decr(rz);
		JB_Decr(item);
		return nil;
	}
...
Message* JB_Tk__DecorateThing(Message* R, int Ops) {
	...
	if (((bool)(Ops & kJB__Tk_OppTemporal))) {
		...
		if (opp) {
			if (JB_Msg_SyntaxEquals(opp, JB_LUB[62], false)) {
...
int JB_Tk__EmbeddedCode(JB_String* close, Message* dest, int TmpoFlags) {
	...
	if (JB_Tk__NextStart() > result) {
		FastString* _fsf1 = JB_Incr(JB_FS__New());
		JB_FS_AppendString(_fsf1, JB_LUB[65]);
		JB_FS_AppendString(_fsf1, close);
		JB_FS_AppendString(_fsf1, JB_LUB[66]);
...
void JB_Tk__ErrorEvent(int Start, int ExpectedBits, int RealBits) {
	...
	if ((!(((bool)(RealBits & kJB__Tk_illegalchar))))) {
		if ((!(((bool)ExpectedBits) and (((bool)RealBits) and ((bool)JB_Tk__FindError(ExpectedBits)))))) {
			JB_FS_AppendString(Err, JB_LUB[67]);
		}
		 else {
			{
				int _Valuef1 = 0;
			...
			;
			JB_FS_AppendString(Err, JB_LUB[68]);
		}
	}
	if (RealBits == kJB__Tk_EndOfLine) {
		JB_FS_AppendString(Err, JB_LUB[69]);
	}
	 else if ((!RealBits)) {
		JB_FS_AppendString(Err, JB_LUB[70]);
	}
	 else {
		...
		if (((bool)(RealBits & kJB__Tk_illegalchar))) {
			JB_FS_AppendString(Err, JB_LUB[71]);
			...
			if (JB_byte_CanPrintAsNormalChar(illegal)) {
				...
				JB_FS_AppendString(Err, JB_LUB[72]);
...
void JB_Tk__ErrorLetter(int Start) {
	JB_FreeIfDead(JB_Tk__ErrorAdd(JB_LUB[73], Start));
}
...
bool JB_Tk__ExpectEndChar(int start, JB_String* s, bool Expect) {
	...
	if (Expect) {
		FastString* _fsf0 = JB_Incr(JB_FS__New());
		JB_FS_AppendString(_fsf0, JB_LUB[74]);
...
Message* JB_Tk__fAccess(int Start, Message* Parent) {
	...
	JB_Tk__ParseLoopFlags(prms, JB_LUB[75], 0);
...
Message* JB_Tk__fArgOpen(int Start, Message* Parent) {
	...
	JB_SetRef(rz, JB_Tk__NewParentName(nil, JB_SyxArg, Start, JB_LUB[0]));
	(JB_Msg_SyntaxIsSet(rz, kJB__MsgUIFlags_Style2, true));
	JB_Tk__ParseLoopFlags(rz, JB_LUB[76], kJB__Tk_Temporal);
	JB_SafeDecr(rz);
	return rz;
}
...
Message* JB_Tk__fArray(int Start, Message* Parent) {
	...
	JB_Tk__ParseLoopFlags(rz, JB_LUB[75], kJB__Tk_TemporalSyxNoBar);
	JB_SafeDecr(rz);
	return rz;
}
...
Message* JB_Tk__fBackTick(int Start, Message* Parent) {
	...
	if ((!JB_Ind_SyntaxCast(After))) {
		return JB_Tk__ErrorAdd(JB_LUB[77], Start);
	}
...
Message* JB_Tk__fBinary(int Start, Message* Parent) {
	Ind End = JB_Str_InStr(JB__Tk_Data, JB_LUB[78], Start + 2, JB_int__max(), false);
...
Message* JB_Tk__fBracket(int Start, Message* Parent) {
	...
	bool Lines = JB_Tk__ParseLoopFlags(rz, JB_LUB[80], kJB__Tk_TemporalSyxNoBar);
...
Message* JB_Tk__fChar(int Start, Message* Parent) {
	...
	if ((!(rz))) {
		JB_Decr(rz);
		return JB_Tk__ErrorAdd(JB_LUB[81], JB_Tk__NextStart());
	}
	JB_SafeDecr(rz);
	return rz;
}
...
Message* JB_Tk__fComment(int Start, Message* Parent) {
	...
	while (true) {
		...
		if ((!JB_Ind_SyntaxCast(i))) {
			JB_Decr(d);
			return JB_Tk__ErrorAdd(JB_LUB[82], Start);
		}
...
Message* JB_Tk__fDotAccess(int Start, Message* Parent) {
	...
	JB_SetRef(name->Name, JB_Str_ReplaceAll(name->Name, JB_LUB[83], JB_LUB[84], false, nil));
...
Message* JB_Tk__fError2(int Start, Message* Parent) {
	return JB_Tk__ErrorAdd(JB_LUB[85], Start);
}
...
Message* JB_Tk__FillXML(Message* XML, Ind i) {
	...
	while (true) {
		...
		if ((!(JB_Ind_SyntaxCast(i)))) {
			JB_Decr(s);
			return JB_Tk__ErrorAdd(JB_LUB[86], XML->Position);
		}
		...
		if (next != '!') {
		 ...
		 else if (JB_Str_MidEquals(s, i, JB_LUB[87], false)) {
			Message* _tmPf1 = JB_Incr(JB_Tk__XMLWhatever(i, 4, JB_LUB[88], JB_SyxXCom));
			if ((!_tmPf1)) {
				JB_Decr(s);
				JB_Decr(_tmPf1);
				return nil;
		 ...
		 else if (JB_Str_MidEquals(s, i, JB_LUB[89], false)) {
			Message* _tmPf2 = JB_Incr(JB_Tk__XMLWhatever(i, 9, JB_LUB[90], JB_SyxXCDT));
			if ((!_tmPf2)) {
				JB_Decr(s);
				JB_Decr(_tmPf2);
				return nil;
...
Message* JB_Tk__fMsgList(int Start, Message* Parent) {
	...
	while (JB_Tk__NextLineAndIndent(Result).Lines) {
		...
		if (JB_Str_OperatorEndsWith(item->Name, JB_LUB[91])) {
			JB_Decr(Result);
			Message* _tmPf1 = JB_Incr(JB_Tk__ErrorAdd(JB_LUB[92], item->Position));
			JB_Decr(item);
			JB_SafeDecr(_tmPf1);
			return _tmPf1;
		}
	...
	JB_Tk__ExpectEndChar(Start, JB_LUB[91], true);
...
Message* JB_Tk__fOppBracket(int Start, Message* Parent) {
	...
	JB_Decr(opp2);
	JB_Decr(opp1);
	JB_Tk__ExpectEndChar(Start, JB_LUB[80], true);
...
Message* JB_Tk__fOppSyxNeq(int Start, Message* Parent) {
	...
	if ('=' == JB_Tk__NextByte()) {
		JB_Decr(result);
		return JB_Tk__ErrorAdd(JB_LUB[93], JB_Tk__NextStart());
	}
	JB_SafeDecr(result);
	return result;
}
...
Message* JB_Tk__fQuoteLang(int Start, Message* Parent) {
	...
	JB_Tk__ParseLoopFlags(rz, JB_LUB[94], kJB__Tk_TemporalSyxNoBar);
	return rz;
}
...
Message* JB_Tk__fString(int Start, Message* Parent) {
	...
	if ((!(JB_Ind_SyntaxCast(After)))) {
		return JB_Tk__ErrorAdd(JB_LUB[95], JB_Tk__NextStart());
	}
	Ind StrPos = Start + 1;
	...
	while (JB_Ind_SyntaxCast(StrPos)) {
		...
		if (C0 == '{') {
			StrPos = JB_Tk__EmbeddedCode(JB_LUB[76], result, kJB__Tk_TemporalSyx);
		}
		 else {
		...
		if (StrPos > After) {
			JB_Decr(result);
			return JB_Tk__ErrorAdd(JB_LUB[96], NewStrPos);
		}
	};
...
Message* JB_Tk__fSuperStr(int Start, Message* Parent) {
	...
	while (true) {
		...
		if (JB_Str_MidEquals(d, After - 2, JB_LUB[97], false)) {
			Nest++;
		}
		 else if (JB_Str_MidEquals(d, After, JB_LUB[98], false)) {
			Nest--;
			if ((!Nest)) {
...
Message* JB_Tk__fSyntacticComment(int Start, Message* Parent) {
	...
	JB_Tk__EmbeddedArg(JB_LUB[99], rz, kJB__Tk_TemporalSyx);
	JB_SafeDecr(rz);
	return rz;
}
	...
	if (JB_Tk__CanStatement()) {
		while (true) {
			...
			if (JB_Msg_EqualsSyx(item, JB_SyxArg, false)) {
				...
				JB_Decr(_tmPf0);
				if (((bool)SubTmp) or (JB_Msg_SyntaxEquals(item, JB_LUB[100], false))) {
					JB_Decr(item);
					JB_Decr(SubTmp);
					JB_SafeDecr(result);
					return result;
...
Message* JB_Tk__fXML_Comment(int Start, Message* Parent) {
	return JB_Tk__XMLWhatever(Start, 4, JB_LUB[88], JB_SyxXCom);
}
...
Message* JB_Tk__fXML_DocType(int Start, Message* Parent) {
	{
		...
		while (_LoopSrcf0[0] < _LoopSrcf0[1]) {
			...
			if (c == '[') {
				...
				if ((!(i))) {
					return JB_Tk__ErrorAdd(JB_LUB[101], Start);
				}
			}
			 else if (c == '>') {
				(JB_Tk__NextStartSet(i + 1));
...
Message* JB_Tk__fXML_PI(int Start, Message* Parent) {
	...
	JB_Tk__ParseLoopFlags(rz, JB_LUB[102], kJB__Tk_Temporal);
	JB_SafeDecr(rz);
	return rz;
}
...
Message* JB_Tk__IndentBug(Message* curr) {
	JB_DoAt(1);
	return JB_Tk__ErrorAlwaysAdd(JB_LUB[103], curr->Position);
}
...
void JB_Tk__Init() {
	...
	JB_Decr(_tmPf3);
	(JB_Tk__TokenSet(JB_LUB[100], _tmPf2));
	JB_Decr(_tmPf2);
	JB_SetRef(JB__Tk_EndOfLineMarker, JB_Msg__NewNormal(nil, JB_LUB[106]));
	Array* numb = JB_Incr(JB_Str_ByteSplit(JB_LUB[107]));
	JB_String* op_comp = JB_Incr(JB_LUB[108]);
	JB_String* op_math = JB_Incr(JB_LUB[109]);
	JB_String* PFix = JB_Incr(JB_LUB[110]);
	...
	JB_Decr(_tmPf9);
	(JB_Tk__TokenSet(JB_LUB[63], _tmPf8));
	JB_Decr(_tmPf8);
	...
	JB_Decr(_tmPf23);
	(JB_Tk__TokenSet(JB_LUB[117], _tmPf22));
	JB_Decr(_tmPf22);
	...
	JB_Decr(_tmPf25);
	(JB_Tk__TokenSet(JB_LUB[118], _tmPf24));
	JB_Decr(_tmPf24);
	JB_Tk__TokenzFn(JB_LUB[119], kJB__Tk_ThingSyx, JB_Tk__fBeforeRelMinus);
	JB_Tk__TokenzFn(PFix, kJB__Tk_ThingSyx, JB_Tk__fBeforeRel);
	JB_Tk__TokenzFn(PFix, kJB__Tk_FuncAfterNormal, JB_Tk__fAfterRel);
	JB_Decr(PFix);
	JB_Tk__TokenzFn(JB_LUB[33], kJB__Tk_ThingSyx, JB_Tk__fBeforeRel);
	JB_Tk__TokenzFn(JB_LUB[120], kJB__Tk_ThingSyx, JB_Tk__fArgOpen);
	JB_Tk__TokenzFn(JB_LUB[121], kJB__Tk_TmpOpp, JB_Tk__fTemporalRelSyx);
	JB_Tk__TokenzFn(JB_LUB[122], kJB__Tk_TmpOpp, JB_Tk__fSyntacticComment);
	JB_Tk__TokenzFn(JB_LUB[123], kJB__Tk_ThingSyx, JB_Tk__fOpAsThing);
	JB_Tk__TokensFn(numb, kJB__Tk_ThingSyx, JB_Tk__fNumber);
	JB_Decr(numb);
	JB_Tk__TokenzFn(JB_LUB[124], kJB__Tk_TemporalSyxNoBar, JB_Tk__fShebang);
	JB_Tk__TokenzFn(JB_LUB[125], kJB__Tk_EndOfLine, JB_Tk__fCommentLine);
	JB_Tk__TokenzFn(JB_LUB[126], kJB__Tk_EndOfLine, JB_Tk__fComment);
	JB_Tk__TokenzFn(op_comp, kJB__Tk_OppSNB, JB_Tk__fOppSyxNeq);
	JB_Decr(op_comp);
	JB_Tk__TokenzFn(op_math, kJB__Tk_OppSNB, JB_Tk__fOppSyx);
	JB_Decr(op_math);
	JB_Tk__TokenzFn(JB_LUB[58], kJB__Tk_OppBar, JB_Tk__fOppSyx);
	JB_Tk__TokenzFn(JB_LUB[127], kJB__Tk_ThingSyx, JB_Tk__fThingSyx);
	JB_Tk__TokenzFn(JB_LUB[25], kJB__Tk_ThingSyx, JB_Tk__fString);
	JB_Tk__TokenzFn(JB_LUB[27], kJB__Tk_ThingSyx, JB_Tk__fChar);
	JB_Tk__TokenzFn(JB_LUB[128], kJB__Tk_ThingSyx, JB_Tk__fBackTick);
	JB_Tk__TokenzFn(JB_LUB[97], kJB__Tk_ThingSyx, JB_Tk__fSuperStr);
	JB_Tk__TokenzFn(JB_LUB[129], kJB__Tk_ThingSyx, JB_Tk__fBinary);
	...
	JB_Decr(_tmPf27);
	(JB_Tk__TokenSet(JB_LUB[130], _tmPf26));
	JB_Decr(_tmPf26);
	...
	JB_Decr(_tmPf29);
	(JB_Tk__TokenSet(JB_LUB[131], _tmPf28));
	JB_Decr(_tmPf28);
	JB_Tk__TokenzFn(JB_LUB[132], kJB__Tk_ThingSyx, JB_Tk__fInnerNiceAdj);
	JB_Tk__TokenzFn(JB_LUB[133], kJB__Tk_ThingSyx, JB_Tk__fYoda);
	JB_Tk__TokenzFn(JB_LUB[134], kJB__Tk_ThingSyx, JB_Tk__fQuoteLang);
	JB_Tk__TokenzFn(JB_LUB[83], kJB__Tk_ThingSyx, JB_Tk__fQuestion);
	JB_Tk__TokenzFn(JB_LUB[135], kJB__Tk_ThingSyx, JB_Tk__fAsk);
	JB_Tk__TokenzFn(JB_LUB[37], kJB__Tk_TemporalSyx, JB_Tk__fXML);
	JB_Tk__TokenzFn(JB_LUB[136], kJB__Tk_TemporalSyx, JB_Tk__fXML_PI);
	JB_Tk__TokenzFn(JB_LUB[87], kJB__Tk_TemporalSyx, JB_Tk__fXML_Comment);
	JB_Tk__TokenzFn(JB_LUB[137], kJB__Tk_TemporalSyx, JB_Tk__fXML_DocType);
	JB_Tk__TokenzFn(JB_LUB[138], kJB__Tk_EndContainer, JB_Tk__fEndOfLine);
	JB_Tk__TokenzFn(JB_LUB[139], kJB__Tk_ThingSyx, JB_Tk__fError);
	JB_Tk__TokenzFn(JB_LUB[140], kJB__Tk_OppSyx, JB_Tk__fError2);
...
int JB_Tk__Init_() {
	{
		JB_SetRef(JB__Tk_ErrorTabsAfterSpaces, JB_LUB[141]);
...
Message* JB_Tk__MakeRel(Message* first, int Bits) {
	...
	JB_Tree_SyntaxAppend(Rel, first);
	JB_Tree_SyntaxAppend(Rel, opp);
	if (JB_Tk__EatString(JB_LUB[142])) {
		Rel->Func = JB_SyxERel;
		opp->Extra++;
	}
...
int JB_Tk__MessageErrorSub(FastString* fs, int num, int ButFound) {
	if ((!JB__Tk_ErrorNames)) {
		...
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_Temporal, JB_LUB[143]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_TemporalSyx, JB_LUB[144]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_TemporalWord, JB_LUB[145]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_EndOfLine, JB_LUB[69]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_colon, JB_LUB[146]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_OppSyx, JB_LUB[147]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_OppWord, JB_LUB[147]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_Opp, JB_LUB[147]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_OppTemporal, JB_LUB[148]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_Thing, JB_LUB[149]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_ThingWord, JB_LUB[149]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_ThingSyx, JB_LUB[150]));
		(JB_Dict_SetInt(JB__Tk_ErrorNames, kJB__Tk_illegalchar, JB_LUB[151]));
	}
	if (fs->Length) {
...
bool JB_Tk__NeedName(Message* thg) {
	...
	return ((bool)JB_FreeIfDead(JB_Tk__ErrorAdd(JB_LUB[155], thg->Position)));
}
...
void JB_Tk__Params(Message* Parent, int N) {
	...
	JB_Tk__ParseLoopFlags(Result, JB_LUB[80], kJB__Tk_TemporalSyxNoBar);
	JB_Decr(Result);
}
...
Message* JB_Tk__PostInnerAdj(Message* Rel, Message* opp) {
	...
	if ((!(JB_Msg_EqualsSyx(Rel, JB_SyxRel, false))) and (!((JB_Msg_EqualsSyx(Rel, JB_SyxBra, false)) and (JB_Msg_EqualsSyx(f, JB_SyxRel, false))))) {
		Message* _tmPf1 = JB_Incr(JB_Tk__ErrorAdd(JB_LUB[156], Rel->Position));
		JB_Decr(Rel);
		JB_Decr(f);
		JB_SafeDecr(_tmPf1);
		return _tmPf1;
...
Message* JB_Tk__ReRoute(Message* output, Message* cnj, Message* f) {
	...
	if ((!f)) {
		JB_Decr(rz);
		return JB_Tk__ErrorAdd(JB_LUB[157], JB_Tk__NextStart());
	}
...
void JB_Tk__TokenzFn(JB_String* s, int bits, ParseHandler func) {
	if (JB_Str_ContainsString(s, JB_LUB[84])) {
...
Message* JB_Tk__UnexpectedSyntax(Message* bad) {
	return JB_Tk__ErrorAdd(JB_LUB[85], bad->Position);
}
...
int JB_Tk__XMLAttribs(Message* XML, int start) {
	...
	while (true) {
		...
		if ((!JB_Tk__ExpectEndChar(JB_Tk__NextStart(), JB_LUB[142], true))) {
			JB_Decr(AllAtts);
			JB_Decr(s);
			JB_Decr(Attr);
			return nil;
		...
		c = JB_Str_ByteValue(s, i);
		if ((!((c == '\'') or (c == '"')))) {
			JB_FreeIfDead(JB_Tk__ErrorAdd(JB_LUB[158], i));
			JB_Decr(AllAtts);
			JB_Decr(s);
			JB_Decr(Attr);
			return nil;
	...
	JB_Decr(s);
	JB_Decr(AllAtts);
	JB_FreeIfDead(JB_Tk__ErrorAdd(JB_LUB[159], JB_Tk__NextStart()));
	return 0;
}
...
Message* JB_Tk__XMLWhatever(int s, int skip, JB_String* ender, Syntax fn) {
	...
	if ((!JB_Ind_SyntaxCast(EndPos))) {
		JB_Decr(rz);
		return JB_Tk__ErrorAdd(JB_LUB[160], i);
	}
...
void JB_Platform__Log(JB_String* s) {
	...
	JB_File_SyntaxAppend(JB__Platform_Logger, JB_LUB[19]);
}

void JB_Platform__OpenLog(JB_String* path) {
	JB_Incr(path);
	if ((!(JB_Str_Exists(path)))) {
		JB_File* _tmPf0 = JB_Incr(JB_File__Logs());
		JB_String* _tmPf2 = JB_Incr(JB_App__AppName());
		JB_String* _tmPf1 = JB_Incr(JB_Str_OperatorPlus(_tmPf2, JB_LUB[161]));
		JB_Decr(_tmPf2);
		JB_SetRef(path, JB_File_SyntaxAccess(_tmPf0, _tmPf1, false));
		JB_Decr(_tmPf1);
		JB_Decr(_tmPf0);
	}
...
bool JB_Platform__osx() {
	...
	bool _tmPf1 = JB_Str_Equals(_tmPf0, JB_LUB[162], false);
	JB_Decr(_tmPf0);
	return (_tmPf1);
}
...
int JB_zalgo__Init_() {
	{
		JB__zalgo_R = ((Random){});
		JB_SetRef(JB__zalgo_up, JB_LUB[163]);
		JB_SetRef(JB__zalgo_mid, JB_LUB[164]);
		JB_SetRef(JB__zalgo_down, JB_LUB[165]);
	}
	;
	return 0;
}
...
void App_DoAction_duck(RPGHero* self, JB_String* Reason) {
	FastString* _fsf0 = JB_Incr(JB_FS__New());
	JB_FS_AppendString(_fsf0, self->Name);
	JB_FS_AppendString(_fsf0, JB_LUB[166]);
	JB_FS_AppendString(_fsf0, Reason);
	JB_String* _tmPf1 = JB_Incr(JB_FS_GetResult(_fsf0));
	JB_Decr(_fsf0);
	JB_PrintLine(_tmPf1);
	JB_Decr(_tmPf1);
...
void App_DoAction_jump(RPGHero* self, JB_String* Reason) {
	FastString* _fsf0 = JB_Incr(JB_FS__New());
	JB_FS_AppendString(_fsf0, self->Name);
	JB_FS_AppendString(_fsf0, JB_LUB[167]);
	JB_FS_AppendString(_fsf0, Reason);
	JB_String* _tmPf1 = JB_Incr(JB_FS_GetResult(_fsf0));
	JB_Decr(_fsf0);
	JB_PrintLine(_tmPf1);
	JB_Decr(_tmPf1);
	if (self->OnGround) {
		self->YSpeed = ((JB_int_OperatorMax(self->YSpeed, 0)) + 2);
	}
}

void App_DoAction_run(RPGHero* self, JB_String* Reason) {
	FastString* _fsf0 = JB_Incr(JB_FS__New());
	JB_FS_AppendString(_fsf0, self->Name);
	JB_FS_AppendString(_fsf0, JB_LUB[168]);
	JB_FS_AppendString(_fsf0, Reason);
	JB_String* _tmPf1 = JB_Incr(JB_FS_GetResult(_fsf0));
	JB_Decr(_fsf0);
	JB_PrintLine(_tmPf1);
	JB_Decr(_tmPf1);
	self->GroundSpeed = JB_int_OperatorMin(self->GroundSpeed, 5);
}

int JB_Init_() {
	{
		JB_SetRef(JB__JbinHeader, JB_LUB[169]);
		JB_SetRef(JB__SyxDict_, JB_Dict__New());
		JB_SyxNil = JB_Syx__StdNew(JB_Msg_Nil__, JB_LUB[170], JB_LUB[171]);
		JB_SyxArg = JB_Syx__StdNew(JB_Msg_Arg__, JB_LUB[172], JB_LUB[173]);
		JB_SyxBra = JB_Syx__StdNew(JB_Msg_Bra__, JB_LUB[174], JB_LUB[175]);
		JB_SyxThg = JB_Syx__StdNew(JB_Msg_Thg__, JB_LUB[176], JB_LUB[177]);
		JB_SyxOpp = JB_Syx__StdNew(JB_Msg_Opp__, JB_LUB[178], JB_LUB[179]);
		JB_SyxCnj = JB_Syx__StdNew(JB_Msg_Cnj__, JB_LUB[180], JB_LUB[181]);
		JB_SyxTmp = JB_Syx__StdNew(JB_Msg_Tmp__, JB_LUB[182], JB_LUB[183]);
		JB_SyxName = JB_Syx__StdNew(JB_Msg_Name__, JB_LUB[184], JB_LUB[0]);
		JB_SyxQues = JB_Syx__StdNew(JB_Msg_Ques__, JB_LUB[185], JB_LUB[186]);
		JB_SyxBack = JB_Syx__StdNew(JB_Msg_Back__, JB_LUB[187], JB_LUB[188]);
		JB_SyxChar = JB_Syx__StdNew(JB_Msg_Char__, JB_LUB[189], JB_LUB[190]);
		JB_SyxSStr = JB_Syx__StdNew(JB_Msg_SStr__, JB_LUB[191], JB_LUB[192]);
		JB_SyxOat = JB_Syx__StdNew(JB_Msg_Oat__, JB_LUB[193], JB_LUB[194]);
		JB_SyxSheb = JB_Syx__StdNew(JB_Msg_Sheb__, JB_LUB[195], JB_LUB[196]);
		JB_SyxStr = JB_Syx__StdNew(JB_Msg_Str__, JB_LUB[197], JB_LUB[198]);
		JB_SyxSThg = JB_Syx__StdNew(JB_Msg_SThg__, JB_LUB[199], JB_LUB[200]);
		JB_SyxSCnj = JB_Syx__StdNew(JB_Msg_SCnj__, JB_LUB[201], JB_LUB[202]);
		JB_SyxNum = JB_Syx__StdNew(JB_Msg_Num__, JB_LUB[203], JB_LUB[204]);
		JB_SyxEmb = JB_Syx__StdNew(JB_Msg_Emb__, JB_LUB[205], JB_LUB[206]);
		JB_SyxUnit = JB_Syx__StdNew(JB_Msg_Unit__, JB_LUB[207], JB_LUB[0]);
		JB_SyxType = JB_Syx__StdNew(JB_Msg_Type__, JB_LUB[208], JB_LUB[209]);
		JB_SyxARel = JB_Syx__StdNew(JB_Msg_ARel__, JB_LUB[210], JB_LUB[211]);
		JB_SyxDot = JB_Syx__StdNew(JB_Msg_Dot__, JB_LUB[212], JB_LUB[213]);
		JB_SyxSDot = JB_Syx__StdNew(JB_Msg_SDot__, JB_LUB[214], JB_LUB[215]);
		JB_SyxFunc = JB_Syx__StdNew(JB_Msg_Func__, JB_LUB[216], JB_LUB[217]);
		JB_SyxBRel = JB_Syx__StdNew(JB_Msg_BRel__, JB_LUB[218], JB_LUB[219]);
		JB_SyxAdj = JB_Syx__StdNew(JB_Msg_Adj__, JB_LUB[220], JB_LUB[221]);
		JB_SyxBadj = JB_Syx__StdNew(JB_Msg_Badj__, JB_LUB[222], JB_LUB[223]);
		JB_SyxAcc = JB_Syx__StdNew(JB_Msg_Acc__, JB_LUB[224], JB_LUB[225]);
		JB_SyxArr = JB_Syx__StdNew(JB_Msg_Arr__, JB_LUB[226], JB_LUB[227]);
		JB_SyxItem = JB_Syx__StdNew(JB_Msg_Item__, JB_LUB[228], JB_LUB[0]);
		JB_SyxList = JB_Syx__StdNew(JB_Msg_List__, JB_LUB[229], JB_LUB[0]);
		JB_SyxPrm = JB_Syx__StdNew(JB_Msg_Prm__, JB_LUB[230], JB_LUB[231]);
		JB_SyxFile = JB_Syx__StdNew(JB_Msg_File__, JB_LUB[232], JB_LUB[233]);
		JB_SyxQuot = JB_Syx__StdNew(JB_Msg_Quot__, JB_LUB[234], JB_LUB[235]);
		JB_SyxDecl = JB_Syx__StdNew(JB_Msg_Decl__, JB_LUB[236], JB_LUB[237]);
		JB_SyxRel = JB_Syx__StdNew(JB_Msg_Rel__, JB_LUB[238], JB_LUB[239]);
		JB_SyxERel = JB_Syx__StdNew(JB_Msg_ERel__, JB_LUB[240], JB_LUB[241]);
		JB_SyxTRel = JB_Syx__StdNew(JB_Msg_TRel__, JB_LUB[242], JB_LUB[243]);
		JB_SyxTril = JB_Syx__StdNew(JB_Msg_Tril__, JB_LUB[244], JB_LUB[245]);
		JB_Syxpinn = JB_Syx__StdNew(JB_Msg_pinn__, JB_LUB[246], JB_LUB[247]);
		JB_Syxbinn = JB_Syx__StdNew(JB_Msg_binn__, JB_LUB[248], JB_LUB[249]);
		JB_SyxAsk = JB_Syx__StdNew(JB_Msg_Ask__, JB_LUB[250], JB_LUB[0]);
		JB_SyxYoda = JB_Syx__StdNew(JB_Msg_Yoda__, JB_LUB[251], JB_LUB[252]);
		JB_SyxSCom = JB_Syx__StdNew(JB_Msg_SCom__, JB_LUB[253], JB_LUB[254]);
		JB_SyxMsg = JB_Syx__StdNew(JB_Msg_Msg__, JB_LUB[255], JB_LUB[256]);
		JB_SyxTodo = JB_Syx__StdNew(JB_Msg_Todo__, JB_LUB[257], JB_LUB[258]);
		JB_Syxurl = JB_Syx__StdNew(JB_Msg_url__, JB_LUB[259], JB_LUB[260]);
		JB_SetRef(JB_DoAction, (JB_Dict__New()));
		DTWrap* _tmPf0 = JB_Incr(JB_Wrap__New(((_voidptr)(&App_DoAction_jump))));
		(JB_Dict_ValueSet(JB_DoAction, JB_LUB[15], _tmPf0));
		JB_Decr(_tmPf0);
		DTWrap* _tmPf1 = JB_Incr(JB_Wrap__New(((_voidptr)(&App_DoAction_run))));
		(JB_Dict_ValueSet(JB_DoAction, JB_LUB[261], _tmPf1));
		JB_Decr(_tmPf1);
		DTWrap* _tmPf2 = JB_Incr(JB_Wrap__New(((_voidptr)(&App_DoAction_duck))));
		(JB_Dict_ValueSet(JB_DoAction, JB_LUB[262], _tmPf2));
		JB_Decr(_tmPf2);
		JB_SyxXAtt = JB_Syx__StdNew(JB_Msg_XAtt__, JB_LUB[263], JB_LUB[264]);
		JB_SyxXML = JB_Syx__StdNew(JB_Msg_XML__, JB_LUB[265], JB_LUB[266]);
		JB_SyxXPI = JB_Syx__StdNew(JB_Msg_XPI__, JB_LUB[267], JB_LUB[268]);
		JB_SyxXCom = JB_Syx__StdNew(JB_Msg_XCom__, JB_LUB[269], JB_LUB[270]);
		JB_SyxXCDT = JB_Syx__StdNew(JB_Msg_XCDT__, JB_LUB[271], JB_LUB[272]);
		JB_SyxXTxt = JB_Syx__StdNew(JB_Msg_XTxt__, JB_LUB[273], JB_LUB[274]);
		JB_SyxBin = JB_Syx__StdNew(JB_Msg_Bin__, JB_LUB[275], JB_LUB[276]);
	}
	;
	//// App;
	JB_App__Init_();
...
void App_MeSayer(JB_String* input) {
	FastString* _fsf0 = JB_Incr(JB_FS__New());
	JB_FS_AppendString(_fsf0, JB_LUB[277]);
	JB_FS_AppendString(_fsf0, input);
	JB_String* _tmPf1 = JB_Incr(JB_FS_GetResult(_fsf0));
	JB_Decr(_fsf0);
	JB_PrintLine(_tmPf1);
	JB_Decr(_tmPf1);
...
void App_SheSayer(JB_String* input) {
	FastString* _fsf0 = JB_Incr(JB_FS__New());
	JB_FS_AppendString(_fsf0, JB_LUB[278]);
	JB_FS_AppendString(_fsf0, input);
	JB_FS_AppendString(_fsf0, JB_LUB[279]);
	JB_String* _tmPf1 = JB_Incr(JB_FS_GetResult(_fsf0));
	JB_Decr(_fsf0);
	JB_PrintLine(_tmPf1);
	JB_Decr(_tmPf1);
...
void JB_Saver_AppendString(ObjectSaver* self, JB_String* s) {
	JB_FS_AppendByte(self->Dest, '`');
	JB_FreeIfDead(JB_Str_ReplaceAll(s, JB_LUB[128], JB_LUB[282], false, self->Dest));
	JB_FS_AppendByte(self->Dest, '`');
	JB_FS_AppendByte(self->Dest, ',');
}
...
void JB_Saver_Destructor(ObjectSaver* self) {
	if (self->CantSaveThis) {
		JB_Object_Fail(self->CantSaveThis, JB_LUB[283]);
	}
	JB_Decr(self->Dest);
}
...
void JB_Object_SyntaxExpect(JB_Object* self) {
	JB_PrintStackTrace();
	JB_Rec_NewErrorWithNode(JB_StdErr, nil, JB_LUB[285], nil);
}
...
JB_String* JB_Wrap_Render(DTWrap* self, FastString* fs_in) {
	...
	if (JB_TC_IsFloat(self->DataType)) {
		...
		JB_String* _tmPf0 = JB_Incr(((JB_String*)JB_Ternary(((bool)self->PrivValue), JB_LUB[286], JB_LUB[287])));
		JB_FS_AppendString(fs, _tmPf0);
		JB_Decr(_tmPf0);
	}
	 else {
...
void JB_Rec_incr(JB_ErrorReceiver* self, JB_Error* err, bool add) {
	...
	if (err->ErrorLevel == kJB__ErrorSeverity_Problem) {
...
void JB_Rec_NewErrorWithNode(JB_ErrorReceiver* self, Message* node, JB_String* Desc, JB_String* path) {
	ErrorSeverity sev = ((ErrorSeverity)JB_Ternary(self->ErrorsAreProblems > 0, kJB__ErrorSeverity_Problem, ((ErrorSeverity)kJB__ErrorSeverity_Error)));
...
void JB_Rec_SyntaxAppend(JB_ErrorReceiver* self, JB_Error* Err) {
	...
	if ((!JB_Rec_CanAddMore(self, Err->ErrorLevel))) {
		return;
	}
	if ((!(JB_Str_Exists(Err->Path)))) {
		JB_SetRef(Err->Path, self->Source);
	}
	if (JB_File_SyntaxCast(self->Log)) {
		JB_String* _tmPf0 = JB_Incr(JB_Err_render(Err, nil));
		JB_File_SyntaxAppend(self->Log, _tmPf0);
		JB_Decr(_tmPf0);
	}
	...
	if (((bool)JB__Err_AutoPrint) and (Err->ErrorLevel >= kJB__ErrorSeverity_Error)) {
		JB_DoAt(1);
	}
...
void JB_FS_AppendObjectOrNil(FastString* self, JB_Object* o) {
	if (JB_Object_Isa(o, JB_AsClass(Saveable))) {
		if (JB_Sav_IsSaveMarked(((Saveable*)o))) {
			...
			JB_FS_AppendString(self, JB_LUB[170]);
		}
	}
...
void JB_FS_ProblemsFound(FastString* self, int count) {
	...
	JB_FS_AppendString(self, JB_LUB[288]);
	if (count > 1) {
		JB_FS_AppendByte(self, 's');
	}
	JB_FS_AppendString(self, JB_LUB[289]);
}
...
void App_Person_ageSet(Person* self, int Value) {
	if ((!((Value > 0) and (Value < 300)))) {
		FastString* _fsf0 = JB_Incr(JB_FS__New());
		JB_FS_AppendString(_fsf0, JB_LUB[290]);
		JB_FS_AppendInt32(_fsf0, Value);
...
void App_Person_ConstructorAuto(Person* self, int age, JB_String* name) {
	self->age = 0;
	JB_String* _tmPf0 = JB_LUB[0];
...
void App_Person_destructor(Person* self) {
	JB_Decr(self->name);
}

Person* App_Person__Alloc() {
	return ((Person*)JB_New(Person));
}

Person* App_Person__NewAuto(int age, JB_String* name) {
	Person* __rz__ = ((Person*)App_Person__Alloc());
	if (__rz__) {
		App_Person_ConstructorAuto(__rz__, age, name);
	}
	return __rz__;
}
...
void JB_Proc_Disconnect(Process* self) {
	...
	if (JB_Proc_SyntaxIsnt(self, kJB__IPCState_closed)) {
		JB_Proc_Self(self, JB_LUB[292], false);
...
void JB_Proc_logus(Process* self) {
	...
	JB_Decr(_tmPf1);
	JB_Proc_log(self, JB_LUB[284]);
}

JB_String* JB_Proc_OurName(Process* self, bool us) {
	if (self->IsServer == us) {
		return JB_Str_OperatorPlus(JB_LUB[293], self->Name);
	}
	 else {
		return JB_Str_OperatorPlus(JB_LUB[294], self->Name);
	}
	return JB_LUB[0];
}
...
JB_String* JB_Proc_ReportConnection(Process* self, JB_String* s, FastString* fs_in) {
	FastString* fs = JB_Incr(JB_FS__FastNew(fs_in));
	JB_FS_AppendString(fs, JB_LUB[295]);
	if (JB_Str_Exists(s)) {
		JB_FS_AppendString(fs, s);
		JB_FS_AppendByte(fs, '\n');
	}
	//;
	JB_FS_AppendString(fs, JB_LUB[296]);
	...
	if (((bool)self->Orig) and (self->Orig != ((byte*)((&self->Dummy))))) {
		//;
		JB_FS_AppendString(fs, JB_LUB[298]);
...
void App_RPGHero_Constructor(RPGHero* self, JB_String* name) {
	self->OnGround = false;
...
void App_RPGHero_destructor(RPGHero* self) {
	JB_Decr(self->Name);
}

RPGHero* App_RPGHero__Alloc() {
	return ((RPGHero*)JB_New(RPGHero));
}

RPGHero* App_RPGHero__New(JB_String* name) {
	RPGHero* __rz__ = ((RPGHero*)App_RPGHero__Alloc());
	if (__rz__) {
		App_RPGHero_Constructor(__rz__, name);
	}
	return __rz__;
}
...
void JB_Sav_SaveWrite(Saveable* self, ObjectSaver* Saver) {
	Saver->CantSaveThis = self;
	JB_FS_AppendString(Saver->Dest, JB_LUB[300]);
}
...
JB_String* JB_Str_BackToApp(JB_String* self) {
	...
	JB_String* Final = JB_Incr(JB_Str_OperatorPlus(JB_LUB[301], _tmPf0));
	JB_Decr(_tmPf0);
...
JB_File* JB_Str_AsFile(JB_String* self) {
	if (JB_Object_FastIsa(self, JB_AsClass(JB_File))) {
		return ((JB_File*)self);
	}
...
JB_String* JB_Str_Parent(JB_String* self) {
	if ((!JB_Str_Equals(self, JB_LUB[302], false))) {
...
Message* JB_Str_Parse(JB_String* self, Syntax owner) {
	Ind j = JB_Str_HiddenJBin(self);
	if (JB_Ind_SyntaxCast(j)) {
		JB_String* _tmPf0 = JB_Incr(JB_Str_Range(self, j, JB_int__max()));
...
Message* JB_Str_ParseWithError(JB_String* self, JB_Error** rec) {
	...
	//visible;
	JB_SetRef((*rec), nil);
	JB_MemoryLayer* L = JB_Class_Layer((JB_AsClass(Message)));
	rz = JB_Str_Parse(self, JB_SyxArg);
	if ((!rz)) {
...
JB_String* JB_Str_PathDir(JB_String* self) {
	if (JB_Str_Exists(self) and (JB_Str_Last(self, 0) != '/')) {
		return JB_Str_OperatorPlus(self, JB_LUB[302]);
	}
	return self;
}
...
CharSet* JB_Str_UniCS(JB_String* self) {
	JB_String* _tmPf0 = JB_Incr(JB_Str_OperatorPlus(self, JB_LUB[303]));
	...
	while (JB_ss_SyntaxCast(self)) {
		...
		if (Dir == 3) {
			...
			if (msg->Func > JB_SyxBin) {
				if ((!false)) {
					JB_Msg_SyntaxExpect(msg, JB_LUB[304]);
				}
				msg->Func = JB_SyxTmp;
			}
			if ((!(rz))) {
...
Message* JB_ss_Parse_Jbin(StringStream* self) {
	...
	if ((!_tmPf0)) {
		JB_ss_SyntaxExpect(self, JB_LUB[305]);
		JB_Decr(_tmPf0);
		return nil;
	}
	JB_SafeDecr(_tmPf0);
...
void JB_ss_SyntaxExpect(StringStream* self, JB_String* Error) {
	JB_DoAt(1);
	JB_String* msg = JB_LUB[306];
	JB_String* p = JB_LUB[0];
	if (self->File != nil) {
		msg = JB_LUB[307];
		p = JB_File_Path(self->File);
	}
	JB_Rec_NewErrorWithNode(JB_StdErr, nil, msg, p);
}

StringStream* JB_ss_test(StringStream* self, int a, JB_String* b) {
	if ((!JB_Str_Exists(b)) or (({
		JB_String* _tmP123 = JB_Incr(JB_ss_Str(self, JB_Str_Length(b), 0));
		bool _tmP122 = JB_Str_Equals(_tmP123, b, false);
		JB_Decr(_tmP123);
		 _tmP122;
	}))) {
		return self;
...
void JB_Array_SaveWrite(Array* self, ObjectSaver* Saver) {
	FastString* D = Saver->Dest;
	{
		...
		while (_if0 < JB_Array_Size(self)) {
			JB_Object* v = JB_Array_Value(self, _if0);
			if (_firstf2 != _if0) {
				JB_FS_AppendString(D, JB_LUB[308]);
			}
			//start;
...
void JB_Dict_SaveWrite(Dictionary* self, ObjectSaver* Saver) {
	...
	while (JB_DictionaryReader_SyntaxCast(L)) {
		...
		JB_FS_AppendString(D, JB_LUB[284]);
...
JB_File* JB_File_Child(JB_File* self, JB_String* name, bool errs) {
	if (JB_Str_Exists(name)) {
		...
		if ((!false)) {
			FastString* _fsf0 = JB_Incr(JB_FS__New());
			JB_FS_AppendString(_fsf0, JB_LUB[309]);
			JB_FS_AppendString(_fsf0, name);
			JB_FS_AppendString(_fsf0, JB_LUB[310]);
	...
	if ((!false)) {
		JB_String* _tmPf5 = JB_Incr(JB_Str_OperatorPlus(JB_LUB[312], self));
...
void JB_File_Fail(JB_File* self, JB_String* Error) {
	...
	JB_Rec_NewErrorWithNode(JB_StdErr, nil, Error, p);
}
...
JB_File* JB_File__Logs() {
	return JB_Str_AsFile(JB_LUB[313]);
}
...
void JB_Msg_Arr__(Message* self, FastString* fs) {
	JB_FS_AppendByte(fs, '[');
	JB_Msg_FSListSep(self, fs, JB_LUB[308]);
	JB_FS_AppendByte(fs, ']');
}

void JB_Msg_Ask__(Message* self, FastString* fs) {
	JB_Msg_BinnRender(self, fs, JB_LUB[135], JB_LUB[0]);
}
...
void JB_Msg_binn__(Message* self, FastString* fs) {
	JB_Msg_BinnRender(self, fs, JB_LUB[317], JB_LUB[0]);
}
...
JB_String* JB_Msg_FilePath(Message* self) {
	...
	if ((!false) and (JB_Object_FastIsa(O, JB_AsClass(JB_File)))) {
...
Message* JB_Msg_GoIntoInvisArg(Message* self, Message* tmp, int pos) {
	...
	if ((!((f == JB_SyxTmp) or ((f == JB_SyxItem) or (f == JB_SyxDecl))))) {
		return JB_Tk__ErrorAdd(JB_LUB[320], tmp->Position);
	}
...
int64 JB_Msg_Int(Message* self, int i) {
	if (self) {
		...
		Message* f = ((Message*)JB_Ring_First(self));
		if (JB_Msg_SyntaxEquals(self, JB_LUB[321], false)) {
			return JB_Str_HexIntegerSection(f->Name, i, f);
		}
		double mul = JB_Str_TextDouble(f->Name, nil);
		if (JB_Msg_SyntaxEquals(self, JB_LUB[322], false)) {
			mul = (mul * 1024);
		}
		 else if (JB_Msg_SyntaxEquals(self, JB_LUB[323], false)) {
			mul = (mul * 1048576);
		}
		 else if (JB_Msg_SyntaxEquals(self, JB_LUB[324], false)) {
			mul = (mul * 1073741824);
		}
		 else {
			if ((!false)) {
				JB_Msg_SyntaxExpect(self, JB_LUB[325]);
			}
			return 0;
		}
		return mul;
...
JB_String* JB_Msg_jdb2_(Message* self, int Flags, FastString* fs_in) {
	FastString* fs = JB_Incr(JB_FS__FastNew(fs_in));
	if (((bool)(Flags & 1))) {
		JB_FS_AppendString(fs, JB_LUB[112]);
	}
...
int JB_Msg_PrevIndentCheck(Message* self, Message* pr) {
	...
	JB_FS_AppendString(_fsf0, JB_LUB[329]);
	...
	JB_FS_AppendString(_fsf1, JB_LUB[329]);
	JB_FS_AppendInt32(_fsf1, chin);
	JB_FS_AppendString(_fsf1, JB_LUB[330]);
...
void JB_Msg_Quot__(Message* self, FastString* fs) {
	JB_FS_AppendString(fs, JB_LUB[134]);
	{
		Message* ch = ((Message*)JB_Tree_First_(self));
		while (ch) {
			Message* _Nf1 = ((Message*)((Message*)JB_Ring_NextSib(ch)));
...
void JB_Msg_SStr__(Message* self, FastString* fs) {
	JB_FS_AppendString(fs, JB_LUB[97]);
	JB_FS_AppendString(fs, self->Name);
...
void JB_Msg_Todo__(Message* self, FastString* fs) {
	JB_FS_AppendString(fs, self->Name);
	JB_Msg_FSListSep(self, fs, JB_LUB[84]);
}
...
void JB_Msg_XPI__(Message* self, FastString* fs) {
	...
	JB_FS_AppendString(fs, JB_LUB[102]);
}
...
void JB_Err_GrabLine(JB_Error* self, FastString* fs, bool Usecolor) {
	...
	JB_Decr(d);
	JB_String* _tmPf0 = JB_Incr(JB_Str_ReplaceAll(_tmPf1, JB_LUB[23], JB_LUB[84], false, nil));
	JB_Decr(_tmPf1);
	JB_FS_AppendString(fs, _tmPf0);
	JB_Decr(_tmPf0);
...
bool JB_Err_IsError(JB_Error* self) {
	return (self->ErrorLevel >= kJB__ErrorSeverity_Error);
}
...
bool JB_Err_NeedsPrint(JB_Error* self) {
	return (self->ErrorLevel >= kJB__ErrorSeverity_Problem);
}
...
JB_String* JB_Err_render(JB_Error* self, FastString* fs_in) {
	...
	if (self->Position >= 0) {
		JB_FS_AppendInfoNum(fs, JB_LUB[341], self->Position);
	}
	JB_FS_AppendInfo(fs, JB_LUB[232], self->Path);
	JB_FS_AppendByte(fs, '\n');
	fs->Indent--;
	JB_String* _tmPf0 = JB_Incr(JB_FS_SmartResult(fs, fs_in));
	JB_Decr(fs);
...
void JB_Err__CantParseNum(Message* Where, JB_String* num, int Pos) {
	...
	JB_FS_AppendString(_fsf0, JB_LUB[344]);
...
// 6203446539140792 7015592394062686