...
#define o2      (r[((Op<<13)>>27)].Obj)
#define o3      (r[((Op<<18)>>27)].Obj)
#define o4      (r[((Op<<23)>>27)].Obj)
#define v1      (r[((Op<< 8)>>27)].Vec)
#define v2      (r[n2].Vec)
#define v3      (r[n3].Vec)
#define v4      (r[n4].Vec)
#define iv1     (r[((Op<< 8)>>27)].Ivec)
#define iv2     (r[((Op<<13)>>27)].Ivec)
#define iv3     (r[((Op<<18)>>27)].Ivec)
#define iv4     (r[((Op<<23)>>27)].Ivec)
