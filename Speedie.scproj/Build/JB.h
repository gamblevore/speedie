...
typedef int (*FP_MicroProcess)(PicoComms* Comms, int64 Mode, _cstring* Args);
...
typedef JB_String* (*FP_fnIDGenerator)(int Start, int End, Syntax F, JB_String* Data);
...
typedef void (*FP_fpMsgExport)(Message* Self, FastString* Fs);

typedef void (*FP_fpMsgExportCpp)(Message* Self, FastStringCpp* Fs);
...
extern bool SC__Comp_DuringConstructorFillIn;
...
extern JB_MemoryLayer* SC__AC_ParseLayer;
...
extern Message* SC__Macros_DoubleQQ;
extern Message* SC__Macros_DylibConstructor;
...
extern Message* SC__Macros_TernQMark;
...
extern bool SC__Options_GenFlowLogCode;
...
extern int SC__VM_Builder_InstructionCount;
...
extern Message* SC_SelfEqNilReturn;
...
#define kJB_SyxXAtt ((Syntax)50)
#define kJB_SyxXCDT ((Syntax)54)
#define kJB_SyxXCom ((Syntax)53)
#define kJB_SyxXDTD ((Syntax)56)
#define kJB_SyxXML ((Syntax)51)
#define kJB_SyxXPI ((Syntax)52)
#define kJB_SyxXTxt ((Syntax)55)
...
#define kJB__zalgo_down ((JB_StringC*)JB_LUB[2010])
#define kJB__zalgo_mid ((JB_StringC*)JB_LUB[2009])
#define JB__zalgo_R JB__.zalgo_R
#define kJB__zalgo_up ((JB_StringC*)JB_LUB[2008])
...
#define kSC__ASM_ADAK ((ASM)45)
#define kSC__ASM_ADD ((ASM)47)
#define kSC__ASM_ADDB ((ASM)43)
#define kSC__ASM_ADDK ((ASM)44)
#define kSC__ASM_ADDM ((ASM)54)
#define kSC__ASM_AFNC ((ASM)39)
#define kSC__ASM_ALLO ((ASM)40)
#define kSC__ASM_BAND ((ASM)62)
#define kSC__ASM_BANG ((ASM)69)
#define kSC__ASM_BANK ((ASM)66)
#define kSC__ASM_BFLG ((ASM)58)
#define kSC__ASM_BLSH ((ASM)61)
#define kSC__ASM_BNOT ((ASM)65)
#define kSC__ASM_BORK ((ASM)67)
#define kSC__ASM_BORR ((ASM)63)
#define kSC__ASM_BRSH ((ASM)60)
#define kSC__ASM_BRSS ((ASM)59)
#define kSC__ASM_BSTT ((ASM)160)
#define kSC__ASM_BXOR ((ASM)64)
#define kSC__ASM_BXRK ((ASM)68)
#define kSC__ASM_CMPF ((ASM)89)
#define kSC__ASM_CMPI ((ASM)88)
#define kSC__ASM_CNTC ((ASM)111)
#define kSC__ASM_CNTD ((ASM)112)
#define kSC__ASM_CONV ((ASM)35)
#define kSC__ASM_DIV ((ASM)50)
#define kSC__ASM_DIV2 ((ASM)51)
#define kSC__ASM_DIVS ((ASM)56)
extern ASM_Encoder SC__ASM_Encoders[256];
#define kSC__ASM_EQUL ((ASM)85)
#define kSC__ASM_FABS ((ASM)165)
#define kSC__ASM_FADD ((ASM)114)
#define kSC__ASM_FADK ((ASM)115)
#define kSC__ASM_FCLM ((ASM)122)
#define kSC__ASM_FCOS ((ASM)176)
#define kSC__ASM_FDIV ((ASM)118)
#define kSC__ASM_FEET ((ASM)36)
#define kSC__ASM_FEXP ((ASM)168)
#define kSC__ASM_FFLR ((ASM)162)
#define kSC__ASM_FFRC ((ASM)161)
#define kSC__ASM_FLG2 ((ASM)171)
#define kSC__ASM_FLNG ((ASM)164)
#define kSC__ASM_FLOG ((ASM)169)
#define kSC__ASM_FMAX ((ASM)120)
#define kSC__ASM_FMIN ((ASM)121)
#define kSC__ASM_FMIX ((ASM)179)
#define kSC__ASM_FMLK ((ASM)117)
#define kSC__ASM_FMOD ((ASM)119)
#define kSC__ASM_FMUL ((ASM)116)
#define kSC__ASM_FNAT ((ASM)174)
#define kSC__ASM_FNC ((ASM)24)
#define kSC__ASM_FNC3 ((ASM)23)
#define kSC__ASM_FNCX ((ASM)26)
#define kSC__ASM_FNCX3 ((ASM)25)
#define kSC__ASM_FNIS ((ASM)172)
extern ASM_Encoder SC__ASM_Forms[128];
#define kSC__ASM_FPOW ((ASM)166)
#define kSC__ASM_FRND ((ASM)163)
#define kSC__ASM_FSGN ((ASM)178)
#define kSC__ASM_FSIN ((ASM)175)
#define kSC__ASM_FSMS ((ASM)180)
#define kSC__ASM_FSOC ((ASM)173)
#define kSC__ASM_FSQT ((ASM)167)
#define kSC__ASM_FTAN ((ASM)177)
#define kSC__ASM_FXNF ((ASM)182)
#define kSC__ASM_FXNN ((ASM)181)
#define kSC__ASM_FXP2 ((ASM)170)
#define kSC__ASM_GOBJ ((ASM)96)
#define kSC__ASM_GRAB ((ASM)37)
#define kSC__ASM_GTAB ((ASM)97)
#define kSC__ASM_HALT ((ASM)0)
#define kSC__ASM_ICLM ((ASM)52)
#define kSC__ASM_JBAN ((ASM)81)
#define kSC__ASM_JBOR ((ASM)80)
#define kSC__ASM_JMKE ((ASM)78)
#define kSC__ASM_JMKL ((ASM)77)
#define kSC__ASM_JMKM ((ASM)76)
#define kSC__ASM_JMKN ((ASM)79)
#define kSC__ASM_JMPE ((ASM)74)
#define kSC__ASM_JMPF ((ASM)73)
#define kSC__ASM_JMPI ((ASM)72)
#define kSC__ASM_JMPN ((ASM)75)
#define kSC__ASM_JTST ((ASM)84)
#define kSC__ASM_JUMP ((ASM)71)
#define kSC__ASM_KNSR ((ASM)41)
#define kSC__ASM_KNST ((ASM)42)
#define kSC__ASM_KNST2 ((ASM)4)
#define kSC__ASM_KNST3 ((ASM)5)
#define kSC__ASM_LUPD ((ASM)83)
#define kSC__ASM_LUPU ((ASM)82)
#define kSC__ASM_MARK ((ASM)255)
#define kSC__ASM_MUL ((ASM)49)
#define kSC__ASM_MULK ((ASM)46)
#define kSC__ASM_MULS ((ASM)57)
extern byte SC__ASM_NoisyASM;
#define kSC__ASM_NOOP ((ASM)33)
#define kSC__ASM_NQUL ((ASM)86)
#define kSC__ASM_PADD ((ASM)156)
#define kSC__ASM_PDIV ((ASM)159)
#define kSC__ASM_PHI ((ASM)254)
#define kSC__ASM_PMUL ((ASM)158)
#define kSC__ASM_PSUB ((ASM)157)
#define kSC__ASM_QADD ((ASM)140)
#define kSC__ASM_QADK ((ASM)144)
#define kSC__ASM_QAND ((ASM)151)
#define kSC__ASM_QCLM ((ASM)145)
#define kSC__ASM_QCNV ((ASM)155)
#define kSC__ASM_QDIV ((ASM)143)
#define kSC__ASM_QFLG ((ASM)147)
#define kSC__ASM_QINC ((ASM)146)
#define kSC__ASM_QLSH ((ASM)150)
#define kSC__ASM_QMUL ((ASM)142)
#define kSC__ASM_QNOT ((ASM)154)
#define kSC__ASM_QORR ((ASM)153)
#define kSC__ASM_QRSH ((ASM)149)
#define kSC__ASM_QRSS ((ASM)148)
#define kSC__ASM_QSUB ((ASM)141)
#define kSC__ASM_QXOR ((ASM)152)
#define kSC__ASM_RALO ((ASM)90)
#define kSC__ASM_RD16 ((ASM)105)
#define kSC__ASM_RD1S ((ASM)99)
#define kSC__ASM_RD1U ((ASM)98)
#define kSC__ASM_RD2S ((ASM)101)
#define kSC__ASM_RD2U ((ASM)100)
#define kSC__ASM_RD4S ((ASM)103)
#define kSC__ASM_RD4U ((ASM)102)
#define kSC__ASM_RD8U ((ASM)104)
#define kSC__ASM_RET ((ASM)38)
#define kSC__ASM_RFRD ((ASM)94)
#define kSC__ASM_RFRT ((ASM)95)
#define kSC__ASM_RFST ((ASM)92)
#define kSC__ASM_RFUN ((ASM)91)
#define kSC__ASM_RFWR ((ASM)93)
#define kSC__ASM_SUB ((ASM)48)
#define kSC__ASM_SUBM ((ASM)55)
#define kSC__ASM_SWAP ((ASM)70)
#define kSC__ASM_TAIL ((ASM)2)
#define kSC__ASM_TERN ((ASM)87)
#define kSC__ASM_TIME ((ASM)34)
#define kSC__ASM_TRAP ((ASM)32)
extern Dictionary* SC__ASM_Types_Dict;
#define kSC__ASM_UADD ((ASM)136)
#define kSC__ASM_UCLM ((ASM)53)
#define kSC__ASM_UDIV ((ASM)139)
#define kSC__ASM_UMUL ((ASM)138)
#define kSC__ASM_USUB ((ASM)137)
#define kSC__ASM_VABS ((ASM)187)
#define kSC__ASM_VADD ((ASM)128)
#define kSC__ASM_VADK ((ASM)129)
#define kSC__ASM_VBLD ((ASM)125)
#define kSC__ASM_VCLM ((ASM)201)
#define kSC__ASM_VCOS ((ASM)198)
#define kSC__ASM_VCRS ((ASM)205)
#define kSC__ASM_VDIV ((ASM)132)
#define kSC__ASM_VDOT ((ASM)204)
#define kSC__ASM_VEXP ((ASM)190)
#define kSC__ASM_VFLR ((ASM)184)
#define kSC__ASM_VFRC ((ASM)183)
#define kSC__ASM_VGET ((ASM)123)
#define kSC__ASM_VLG2 ((ASM)193)
#define kSC__ASM_VLNG ((ASM)186)
#define kSC__ASM_VLOG ((ASM)191)
#define kSC__ASM_VMAX ((ASM)134)
#define kSC__ASM_VMIN ((ASM)135)
#define kSC__ASM_VMIX ((ASM)202)
#define kSC__ASM_VMLK ((ASM)131)
#define kSC__ASM_VMOD ((ASM)133)
#define kSC__ASM_VMOV ((ASM)127)
#define kSC__ASM_VMUL ((ASM)130)
#define kSC__ASM_VNAT ((ASM)196)
#define kSC__ASM_VNIS ((ASM)194)
#define kSC__ASM_VPOW ((ASM)188)
#define kSC__ASM_VRFL ((ASM)206)
#define kSC__ASM_VRND ((ASM)185)
#define kSC__ASM_VSET ((ASM)124)
#define kSC__ASM_VSGN ((ASM)200)
#define kSC__ASM_VSIN ((ASM)197)
#define kSC__ASM_VSMS ((ASM)203)
#define kSC__ASM_VSOC ((ASM)195)
#define kSC__ASM_VSQT ((ASM)189)
#define kSC__ASM_VSUM ((ASM)207)
#define kSC__ASM_VSWZ ((ASM)126)
#define kSC__ASM_VTAN ((ASM)199)
#define kSC__ASM_VXP2 ((ASM)192)
#define kSC__ASM_WCPY ((ASM)113)
#define kSC__ASM_WR16 ((ASM)110)
#define kSC__ASM_WR1U ((ASM)106)
...
#define kSC__Reg_DebugVarClose ((ASMReg)8388608)
#define kSC__Reg_DebugVarOpen ((ASMReg)4194304)
...
#define kSC__CompilerStage_RefCounting ((CompilerStage)4)
...
#define kJB__CL1_Centered ((ControlPoint)10)
#define kJB__CL1_High ((ControlPoint)2)
#define kJB__CL1_Length ((ControlPoint)12)
...
#define kSC__FunctionType_Behaviour ((FunctionType)4096)
...
#define kJB__MoveCode_Edges ((MoveCode)63)
...
#define kSC__khalai_TryingToAssign ((NilCheckMode)128)
...
#define kSC__SCDeclInfo_ASMReached ((SCDeclInfo)536870912)
#define kSC__SCDeclInfo_Body ((SCDeclInfo)4096)
#define kSC__SCDeclInfo_Borrowed ((SCDeclInfo)1)
#define kSC__SCDeclInfo_BothBorrowed ((SCDeclInfo)3)
...
#define kSC__SCDeclInfo_Dylib ((SCDeclInfo)2147483648)
...
#define kSC__SCDeclInfo_Library ((SCDeclInfo)268435456)
...
#define kSC__SCDeclInfo_SuperConstructed ((SCDeclInfo)536870912)
...
#define kJB__TerminalColor_Bold ((JB_StringC*)JB_LUB[2003])
#define kJB__TerminalColor_Cyan ((TerminalColor)36)
#define kJB__TerminalColor_Error ((JB_StringC*)JB_LUB[2004])
#define kJB__TerminalColor_Good ((JB_StringC*)JB_LUB[2005])
#define kJB__TerminalColor_Green ((TerminalColor)32)
#define kJB__TerminalColor_Magenta ((TerminalColor)35)
#define kJB__TerminalColor_Normal ((JB_StringC*)JB_LUB[2002])
#define JB__TerminalColor_RainbowTerm JB__.TerminalColor_RainbowTerm
#define kJB__TerminalColor_Red ((TerminalColor)31)
#define kJB__TerminalColor_Underline ((JB_StringC*)JB_LUB[2005])
...
extern int SC__nil_RestartCount;
...
#define kJB__CakeVM_kBreakAlways ((int)3)
#define kJB__CakeVM_kBreakNever ((int)1)
#define kJB__CakeVM_kBreakStated ((int)2)
...
#define kJB__dylib_Default ((int)6)
...
void SC_Comp__AddGlobalConstFloat(JB_String* Name, SCClass* C, int64 Value);
...
void SC_AC__UnusedStuff(Message* Cmd, JB_String* OK);
...
void SC_PackMaker__BakeCallbacks(FastString* J, FastString* Booma);
...
Message* JB_Tk__fCharSub(int Pos, int Start, uint /*byte*/ Find, Syntax F);
...
Message* JB_Tk__NewAt(Message* Parent, Syntax F, int Start);

Message* JB_Tk__NewParent(Message* Parent, Syntax F, int Start, int End);
...
void SC_Crkt__CorrectStringsSub();
...
void SC_VM_Builder__VM_CleanupList(Message* List, Array* Out);

void SC_VM_Builder__VM_MakeInstructionSub(Message* Tmp, Array* ActuallyMakeTheVM, int ForceID);

void SC_VM_Builder__VM_NewInstructions(Message* List, Array* Out);
...
Message* SC_NewDecl(JB_String* Type, Message* RelOrName);
...
Message* SC_NewFunc(JB_String* Name);
...
int Speedie_Main(PicoComms* Comms, int64 Mode, _cstring* Args);
...
// byte
bool JB_byte_Failed2(uint /*byte*/ Self);
...
float JB_int_OperatorDiv(int Self, int D);
...
ASM SC_ASM_JBitTest_ShSet(ASM Self, uint Value);
...
FatASM* SC_Reg_OptWithin(ASMReg Self);
...
ASMReg SC_ASMType__ExpandBits2(Assembler* Self, Message* Exp, ASMReg Dest, SCDecl* Ty);
...
// CharSet
bool JB_CharSet_ContainsStr(CharSet Self, JB_String* S);
...
uint JB_TC_ByteShift(uint /*DataTypeCode*/ Self);
...
Array* JB_ErrorSeverity__ErrorNames();
...
Syntax JB_Syx__StdNew(FP_fpMsgRender Render, JB_String* Name, JB_String* LongName, int ID);
...
void SC_nil_CheckParam(ArchonPurger* Self, SCDecl* D);
...
void SC_nil_ExterminateZergBugs(ArchonPurger* Self, SCFunction* F);
...
// JB_DynamicLibrary
bool JB_dylib_IsOpen(JB_Dylib* Self);
...
JB_String* JB_Pico_Name(PicoComms* Self);
...
ivec2 JB_TerminalDisplay_Size(TerminalDisplay* Self);

Codepoint JB_TerminalDisplay_SyntaxAccess(TerminalDisplay* Self);
...
void SC_Pac_FillOneTrinParam(Assembler* Self, ASMReg* Collection, FatASM* Fat, Message* S, int I, int MaxParam);
...
void SC_Pac_GrabbedRegisters(Assembler* Self, Message* AllPrms, FatASM* Start, FatASM* Fn);
...
ASMReg SC_Pac_MainBrancher(Assembler* Self, Message* Exp, ASMReg Dest);
...
void SC_Pac_Nop2TempConsts(Assembler* Self, ASMReg A, ASMReg B);
...
ASMReg SC_Pac_TernarySub(Assembler* Self, Message* Exp, ASMReg Dest);
...
// fnIDGenerator
JB_String* JB_fnIDGenerator_id(FP_fnIDGenerator Self, JB_String* Str, Syntax F);
...
void SC_Cpp_FillCake(Cpp_Export* Self);
...
void SC_Cpp_GlobalLibProtoTypes(Cpp_Export* Self, FastString* Fs);

void SC_Cpp_JB_GlobalsMadeHere(Cpp_Export* Self, FastStringCpp* Fs, bool Simple);
...
void SC_Cpp_WriteCakeTests(Cpp_Export* Self, FastString* Fs);
...
JB_String* SC_Cpp__CDotType(Message* Msg, FastStringCpp* Fs, SCDecl* Type, bool DoIt);
...
void SC_Cpp__FunctionPointerCast(SCFunction* Fn, FastString* Fs);
...
void SC_Cpp__WriteTypeWithClassFastStringCppBool(SCClass* C, FastStringCpp* Fs, bool Always);

void SC_Cpp__WriteTypeWithDeclFS(SCDecl* D, FastString* T);
...
void JB_FS_AppendFloat(FastString* Self, float D, int Dp, bool CanExp);

void JB_FS_AppendHexStr(FastString* Self, JB_String* Data);

void JB_FS_AppendHInt(FastString* Self, int64 N);
...
bool SC_Str_CompressTest_(JB_String* Self, bool Report, int Which);

bool SC_Str_CompressTestSub_(JB_String* Self, int Strength, bool Report);
...
Ind JB_Str_OutCharSet(JB_String* Self, CharSet Find, int From, int After);

FastString* JB_Str_OutputStream(JB_String* Self);
...
JB_String* JB_Str_ReplacePathComponent(JB_String* Self, int I, JB_String* With);
...
void JB_Str_SyntaxProblem(JB_String* Self);

bool SC_Str_TargetThg(JB_String* Self, Message* Err);

TerminalColor JB_Str_TerminalColor(JB_String* Self);
...
JB_List* JB_Tree_Parent(JB_List* Self, int N);
...
Message* JB_Msg_Ancestor(Message* Self, Syntax Syx);
...
ASMReg SC_Msg_ASMAllowsTemp(Message* Self);
...
bool SC_Msg_AutoFoundFunc(Message* Self, SCFunction* F);
...
FatASM* SC_Msg_BANG(Message* Self, ASMReg R1, ASMReg R2, int K);
...
void SC_Msg_CommentOut(Message* Self);
...
SCFunction* SC_Msg_DeclFunc(Message* Self);
...
SCFunction* SC_Msg_DylibFix(Message* Self, SCFunction* F, SCDecl* D);

Message* SC_Msg_DylibFuncs(Message* Self);
...
Message* JB_Msg_FindSyxName(Message* Self, Syntax Syx, JB_String* Name, bool Err);
...
Message* JB_Msg_FindNested(Message* Self, Syntax Syx, JB_String* Name, bool Err);
...
void JB_Msg_HInt__(Message* Self, FastString* Fs);
...
bool SC_Msg_InsideParam(Message* Self);
...
FatASM* SC_Msg_JTST(Message* Self, ASMReg R1, int Sh, int Jmp);
...
Message* SC_Msg_MsgFix(Message* Self);
...
void SC_Msg_NeatenDict(Message* Self);
...
FatASM* SC_Msg_NQUL(Message* Self, ASMReg R1, ASMReg R2, ASMReg R3, int Cmp);
...
FatASM* SC_Msg_OptVecMathTwo(Message* Self, ASMReg Dest, ASMReg A, ASMReg B);
...
FatASM* SC_Msg_RFUN(Message* Self, ASMReg R1, ASMReg R2, int Save, ASMReg R4);
...
void SC_Msg_StartCakeVirtual(Message* Self, Message* Prms, Message* WriteTo);
...
FatASM* SC_Msg_SWAP(Message* Self, ASMReg R1, ASMReg R2);
...
void SC_Msg_VirtualAdd(Message* Self, JB_String* Name, bool Cake, Message* Ty, int I);
...
SCDecl* SC_Decl_DownGrade(SCDecl* Self, Message* Orig);
...
SCFunction* SC_Decl_Func(SCDecl* Self);
...
void SC_Decl_MarkAsAltered(SCDecl* Self, Message* Exp);
...
bool SC_Decl_SetSelfProp(SCDecl* Self, Message* Exp, FunctionType Ty);
...
SpdProcess* JB_Proc_Constructor(SpdProcess* Self, JB_String* Path, FP_MicroProcess Fn, PicoComms* Pico, Array* Params, uint /*ProcessMode*/ Mode);
...
bool JB_Macro_Cleaned(Message* Self);

void JB_Macro_CleanedSet(Message* Self, bool Value);

Message* JB_Macro_Constructor(Message* Self, Message* S, bool UseSelf);

Message* JB_Macro_CallFast(Message* Self, Message* Prm1, Message* Prm2, Message* Prm3);

Message* JB_Macro_Source(Message* Self);

int JB_Macro__Init_();

Array* JB_Macro__TmpPrms();
...
bool SC_Class_IsCurrentlyBeingUsed(SCClass* Self);
...
SCNode* SC_Class__NewDylib(Message* Node, SCNode* Name_space, Message* ErrPlace);
...
void SC_Func_ConstructParentProperties(SCFunction* Self);
...
bool SC_Func_Unfinished(SCFunction* Self);
...
SCDecl* SC_Func__Tran_AfterOrBeforeRel(Message* Msg, SCNode* Name_space, Message* Side);
...
inline JB_String* JB_Tk__SyntaxAccess(int S, int E, Syntax F) {
	FP_fnIDGenerator P = JB__Tk_Splitter;
	if (!P) {
		return JB_Tk__Range(S, E);
	}
...
inline Message* JB_Macro_Run(Message* Self, Array* Prms) {
	Message* Msg = JB_Msg_ConstructorEmpty(nil);
	JB_Msg_BecomeMacro(Msg, Self, ((Message*)JB_Array_Value(Prms, 0)), Prms);
	return Msg;
}
