...
#define kJB__ErrorColors_bold (JB_LUB[1763])
extern bool JB__ErrorColors_Enabled;
#define kJB__ErrorColors_error (JB_LUB[1764])
#define kJB__ErrorColors_good (JB_LUB[1765])
#define kJB__ErrorColors_normal (JB_LUB[1766])
#define kJB__ErrorColors_underline (JB_LUB[1765])
#define kJB__ErrorColors_warn (JB_LUB[1767])
...
extern Array* SC__Flatten_PackFuncs;
extern ASMFuncState SC__Flatten_StdState;
...
extern JB_String* JB_file_read_test;
extern fn_asm JB_fn_asm_table[64];
extern Dictionary* JB_FuncLinkageTable;
#define kSC_AddressOfMatch (3)
#define kSC_BitAnd (JB_LUB[412])
#define kSC_BitNot (JB_LUB[510])
#define kSC_BitOr (JB_LUB[615])
#define kSC_BitXor (JB_LUB[1768])
...
#define kJB_SaverStart1 (JB_LUB[1769])
...
JB_String* JB_Str_FileData(JB_String* self, int lim, bool AllowMissing);

bool JB_Str_FileDataSet(JB_String* self, JB_String* Value);
...
bool JB_File_TestSpeedie(JB_File* self, Array* Args, JB_String* Variant);
...
Message* JB_Msg_NeedsArg(Message* self);
