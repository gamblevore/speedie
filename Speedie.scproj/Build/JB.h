...
#define kJB__ErrorColors_bold (JB_LUB[1917])
extern bool JB__ErrorColors_Enabled;
#define kJB__ErrorColors_error (JB_LUB[1918])
#define kJB__ErrorColors_good (JB_LUB[1919])
#define kJB__ErrorColors_normal (JB_LUB[1920])
#define kJB__ErrorColors_underline (JB_LUB[1919])
#define kJB__ErrorColors_warn (JB_LUB[1921])
...
#define kJB_codesign_native (JB_LUB[1922])
...
#define kJB_SaverStart1 (JB_LUB[1924])
