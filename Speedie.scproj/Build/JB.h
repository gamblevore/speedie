...
typedef MsgParseFlags MsgUIFlags;
...
#define kJB__Tk_OppChain (65536 | (4096 | (8192 | 16384)))
...
#define kSC__Blockage_Bits (480)
#define kSC__Blockage_Continue (64)
#define kSC__Blockage_Exit (128)
#define kSC__Blockage_LargestFlag (0)
#define kSC__Blockage_Quit (kSC__Blockage_Return)
#define kSC__Blockage_Return (192)
...
#define kJB__Date_OneStep (0.000015258789f)
...
#define kSC__khalai_LargestFlag (31)
...
#define kSC__khalai_SoftNeg (1 + 4)
#define kSC__khalai_SoftPos (2 + 4)
...
#define kSC__SCDeclInfo_altered (131072)
#define kSC__SCDeclInfo_alteredviapointer (65536)
#define kSC__SCDeclInfo_api (256)
#define kSC__SCDeclInfo_atomic (524288)
#define kSC__SCDeclInfo_body (4096)
...
#define kSC__SCDeclInfo_gameflyingmem (262144)
#define kSC__SCDeclInfo_LargestFlag (4194303)
#define kSC__SCDeclInfo_Local (4096 + 2048)
#define kSC__SCDeclInfo_newlycreated (32)
#define kSC__SCDeclInfo_onmodule (16384)
#define kSC__SCDeclInfo_param (2048)
#define kSC__SCDeclInfo_property (8192)
#define kSC__SCDeclInfo_return (32768)
#define kSC__SCDeclInfo_self (1048576)
#define kSC__SCDeclInfo_SelfImplicit (1048576 + (4096 + 2048))
#define kSC__SCDeclInfo_setto (2097152)
...
#define kSC__ASMtmp_continue (4)
#define kSC__ASMtmp_debugger (12)
#define kSC__ASMtmp_ElseIf (1)
#define kSC__ASMtmp_exit (5)
#define kSC__ASMtmp_fail (13)
#define kSC__ASMtmp_if (2)
#define kSC__ASMtmp_rejoin (7)
#define kSC__ASMtmp_return (6)
#define kSC__ASMtmp_setvar (11)
#define kSC__ASMtmp_statementexpression (10)
#define kSC__ASMtmp_swap (8)
#define kSC__ASMtmp_tern (9)
#define kSC__ASMtmp_while (3)
...
Message* SC_Refs__DeclToDot2(SCDecl* d, JB_String* s);
...
// Blockage
int SC_Blockage_BlockCombine(Blockage self, Blockage B);

bool SC_Blockage_SyntaxIs(Blockage self, Blockage b);
...
// NilState
void SC_NilState_NilName(NilState self, FastString* fs, bool Expected);
...
NilState SC_NilState_Worst(NilState self, NilState o);
...
// SpdProcessMode
bool JB_SpdProcessMode_SyntaxIs(SpdProcessMode self, SpdProcessMode M);
...
// JB_LoopInfo
LoopInfo SC_LoopInfo_Begin(LoopInfo* self, bool HasEscape);

void SC_LoopInfo_Finish(LoopInfo* self, Message* msg);
...
// JB_NilRecorder
void SC_NRC_SyntaxCallSet(NilRecorder* self, int item, NilState value);

NilRecord SC_NRC_SyntaxCall(NilRecorder* self, NilRecord v);
...
Message* SC_nil_Start(ArchonPurger* self, SCFunction* f);

NilState SC_nil__Activate(NilTrackerFn fn, Message* msg, NilCheckMode test);

NilState SC_nil__arel(Message* msg, NilCheckMode Test);

inline NilState SC_nil__ArgOne(Message* s, NilCheckMode t, NilState prev);

NilState SC_nil__Argument(Message* msg, NilCheckMode Test);

NilState SC_nil__BecomeReal(SCDecl* sent, Message* where);
...
void SC_nil__Decls(NilRecord R, JB_String* s);
...
NilRecorder* SC_nil__Place();

NilState SC_nil__ProcessCondRel(Message* msg, NilCheckMode Test);

NilState SC_nil__PropertyOrAccess(Message* msg, NilCheckMode Test);

void SC_nil__PurgeArchons();
...
NilState SC_nil__ThingSub(Message* msg, NilCheckMode Test);

void SC_nil__TrackerDummies();

NilState SC_nil__Type(Message* msg, NilCheckMode Test);

NilState SC_nil__UseChildAsReal(Message* msg);

NilState SC_nil__VariableSet(SCDecl* Recv, SCDecl* Sent, Message* RecvMsg, Message* SentMsg);
...
// JB_Memory
inline void JB_Mrap_ConstructorDummy(MWrap* self, int ItemCount, uint ItemSize, bool DummyParam);
...
inline void SC_PA_Constructor(SCParamArray* self, Message* exp, Message* side);
...
Dictionary* JB_Str_Dict(JB_String* self, byte zep);
...
void JB_bin_AddCstring(FastString* self, Syntax type, _cstring data);
...
inline NilState SC_Decl_NeedsStated(SCDecl* self, Message* where);
...
void SC_Decl_NilDeclaredSet(SCDecl* self, NilState Value);

NilState SC_Decl_NilDeclared(SCDecl* self);

void ndb2(SCDecl* self, JB_String* reason);

void SC_Decl_NilPrmFail(SCDecl* self);
...
SCDecl* SC_Decl_PointerUpgrade(SCDecl* self);
...
JB_String* SC_Decl_PrmStateMsg(SCDecl* self);
...
bool SC_Decl_Suffers(SCDecl* self);
...
void SC_Decl_WantOptional(SCDecl* self);
...
inline void SC_Iter_Constructor(SCIterator* self, SCClass* parent);
...
void SC_Msg_BeLike(Message* self, Message* belikeme);
...
Blockage SC_Msg_Blocks(Message* self);
...
bool SC_Msg_IsNowNil(Message* self);
...
void SC_Msg_LastInBlock(Message* self, Blockage Reason);
...
void SC_Msg_LoopExitter(Message* self, int ASMType, Blockage ExitCode);
...
SCDecl* SC_Msg_MadDecl(Message* self);
...
inline void SC_Class_Constructor(SCClass* self, Message* node, SCBase* parent, bool HasPtrs);
...
bool SC_Class_EqualsStr(SCClass* self, JB_String* Other, bool Aware);
...
SCClass* SC_Class__NeuClassSub(Message* node, SCBase* parent, Message* ErrPlace, JB_String* ForInterface, bool HasPtrs);

SCBase* SC_Class__NeuRole(Message* node, SCBase* name_space, Message* ErrPlace);

SCClass* SC_Class__New(Message* node, SCBase* parent, bool HasPtrs);
...
inline void SC_SCFile_Constructor(SCFile* self, JB_File* f);
...
void ndb1(SCFunction* self, JB_String* header);
...
void JB_Proc_SendCrashed(SpdProcess* self, _cstring signal);
...
void JB_Proc__TellParentIDied(_cstring s);
...
inline NilState SC_nil_SetNilness(ArchonPurger* self, SCDecl* d, NilState New) {
	if ((!d->NilReg) or ((((bool)(New & 1))) and ((!SC_Decl_Suffers(d))))) {
		debugger;
	}
	NilRecorder* P = SC_nil_Place(self);
...
inline void SC_Cpp_Constructor(Cpp_Export* self) {
	...
	self->Outputs_cpp = JB_Incr(_tmPf1);
	Array* _tmPf0 = JB_Array__New0();
	self->Outputs_h = JB_Incr(_tmPf0);
	self->Inlines = nil;
	self->TypesProj = nil;
	self->HeaderProj = nil;
	self->AllTypes = nil;
...
inline void JB_autoitem_ConstructorAuto(autoitem* self, JB_String* Sort, JB_String* Insert, SCObject* Value, JB_String* Display, bool Exact, int type) {
	JB_StringC* _tmPf2 = JB_LUB[0];
	self->Sort = JB_Incr(_tmPf2);
	JB_StringC* _tmPf1 = JB_LUB[0];
	self->Insert = JB_Incr(_tmPf1);
	self->Value = nil;
	JB_StringC* _tmPf0 = JB_LUB[0];
	self->Display = JB_Incr(_tmPf0);
	self->Exact = false;
	self->type = 0;
...
inline void SC_Decl_Constructor(SCDecl* self, SCClass* type) {
	...
	(SC_Decl_NilDeclaredSet(self, kSC__NilState_Either));
...
inline NilState SC_Decl_NeedsStated(SCDecl* self, Message* where) {
	if (SC_NilState_SyntaxIsnt(SC_Decl_NilDeclared(self), kSC__NilState_Stated)) {
		SC_Decl_NilPrmFail(self);
	}
	return 0;
}
...
inline void SC_Class_Constructor(SCClass* self, Message* node, SCBase* parent, bool HasPtrs) {
	...
	self->Properties = JB_Incr(_tmPf6);
	Array* _tmPf5 = JB_Array__New0();
	self->Casts = JB_Incr(_tmPf5);
	Array* _tmPf4 = JB_Array__New0();
	self->Children = JB_Incr(_tmPf4);
	self->Contained = nil;
	self->Signed = nil;
	self->_NotConst = nil;
	self->FuncProto = nil;
	...
	JB_String* _tmPf2 = SC_Class__LoadClassName(node);
	self->Name = JB_Incr(_tmPf2);
	self->Source = JB_Incr(node);
	self->Project = parent->Project;
	(SC_Base_IsVisibleSet(self, SC__Base_CurrVisibility));
	self->SaveAs = nil;
	...
	(SC_Decl_NilDeclaredSet(T, (kSC__NilState_Real >> HasPtrs)));
...
inline void JB_Proc_Constructor(SpdProcess* self, JB_String* path, Array* params, SpdMainFn fn, SpdProcessMode Mode) {
	...
	self->SubProcess = fn;
	self->Mode = Mode;
	FastString* _tmPf2 = ((FastString*)JB_Ternary(JB_SpdProcessMode_SyntaxIs(self->Mode, kJB__SpdProcessMode_capturestdout), JB_FS__New(), nil));
	self->Output = JB_Incr(_tmPf2);
	FastString* _tmPf1 = ((FastString*)JB_Ternary(JB_SpdProcessMode_SyntaxIs(self->Mode, kJB__SpdProcessMode_CaptureOrPrintErrors), JB_FS__New(), nil));
