...
#define kJB_kBitXor (JB_LUB[1883])
...
#define kJB_kSaverStart1 (JB_LUB[1884])
...
bool SC_Func_Matches(SCFunction* self, bool IsAssigns);
...
inline void SC_Class_Constructor(SCClass* self, Message* node, SCBase* parent, bool HasPtrs, SCModule* m) {
	...
	if (JB_Msg_SyntaxEquals(node, JB_LUB[738], false)) {
