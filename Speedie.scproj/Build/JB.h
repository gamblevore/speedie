...
typedef ASM* (*ASM_Encoder2)(FatASM* self, ASM* Curr, ASM* After, int64 ExtraInfo);
...
#define kSC__CustomOps_Needed 256
#define kSC__CustomOps_NotCustom (0)
#define kSC__CustomOps_OnlyLeftIsVector 257
#define kSC__CustomOps_OnlyRightIsVector 258
#define kSC__CustomOps_RecheckType 4
#define kSC__CustomOps_TypeCastFromBool 16
#define kSC__CustomOps_TypeCastToBetter 32
#define kSC__CustomOps_TypeCastToSmaller 64
#define kJB__ErrorColors_bold (JB_LUB[2103])
extern bool JB__ErrorColors_Enabled;
#define kJB__ErrorColors_error (JB_LUB[2104])
#define kJB__ErrorColors_good (JB_LUB[2105])
#define kJB__ErrorColors_normal (JB_LUB[2102])
#define kJB__ErrorColors_underline (JB_LUB[2105])
#define kJB__ErrorColors_warn (JB_LUB[2106])
...
#define kJB_codesign_native (JB_LUB[1665])
...
#define kJB_kSaverStart1 (JB_LUB[2107])
...
#define kJB_kTypeCastForSetRel 2048
#define kJB_kTypeCastFromSmallInt 4096
...
#define kJB_kUsingStr (JB_LUB[1890])
...
#define kJB__zalgo_down (JB_LUB[2110])
#define kJB__zalgo_mid (JB_LUB[2109])
extern Random JB__zalgo_R;
#define kJB__zalgo_up (JB_LUB[2108])
...
#define kSC__Reg_Arg 2097152
#define kSC__Reg_CondAnswer 17179869184
#define kSC__Reg_CondRequest 8589934592
#define kSC__Reg_ConstAny 536870912
#define kSC__Reg_ContainsAddr 1073741824
#define kSC__Reg_CorrectAddr 1073741824
#define kSC__Reg_Decl 12582912
#define kSC__Reg_Discard 2097152
#define kSC__Reg_FatRef 1073741824
#define kSC__Reg_ForCast 33554432
#define kSC__Reg_ForReturn 16777216
#define kSC__Reg_FromMath 65536
#define kSC__Reg_MathConst 536936448
#define kSC__Reg_Negate 1048576
#define kSC__Reg_NeverAltered 134217728
#define kSC__Reg_NotYetUsed 8388608
#define kSC__Reg_Set 4194304
#define kSC__Reg_SingleExpr 268435456
#define kSC__Reg_StayOpen 131072
#define kSC__Reg_Temp 67108864
#define kSC__Reg_Textual 4294967296
#define kSC__Reg_Zero 536870968
...
#define kSC__OpMode_Subtraction 80
...
#define kSC__SCDeclInfo_API 1024
#define kSC__SCDeclInfo_Atomic 16777216
#define kSC__SCDeclInfo_Biggest 268435456
#define kSC__SCDeclInfo_Body 32768
#define kSC__SCDeclInfo_Borrowed 1
#define kSC__SCDeclInfo_ClassObj 2048
#define kSC__SCDeclInfo_CompilerCreated 4096
#define kSC__SCDeclInfo_Const 8
#define kSC__SCDeclInfo_DclCopied 1053794
#define kSC__SCDeclInfo_DirectNumber 4
#define kSC__SCDeclInfo_GameFlyingMem 4194304
#define kSC__SCDeclInfo_Global 131072
#define kSC__SCDeclInfo_Hidden 134217728
#define kSC__SCDeclInfo_IntendedAsReturn 2147483648
#define kSC__SCDeclInfo_Local 49152
#define kSC__SCDeclInfo_NewlyCreated 128
#define kSC__SCDeclInfo_NumberConst 12
#define kSC__SCDeclInfo_Param 16384
#define kSC__SCDeclInfo_PostIncremented 536870912
#define kSC__SCDeclInfo_Property 65536
#define kSC__SCDeclInfo_PropertyWasConstructed 8192
#define kSC__SCDeclInfo_Return 262144
#define kSC__SCDeclInfo_ReturnedStruct 1073741824
#define kSC__SCDeclInfo_Self 33554432
#define kSC__SCDeclInfo_SelfImplicit 33603584
#define kSC__SCDeclInfo_SetTo 67108864
#define kSC__SCDeclInfo_Static 32
#define kSC__SCDeclInfo_StayBorrowed 2
#define kSC__SCDeclInfo_Swappable 245760
#define kSC__SCDeclInfo_Task 8388608
#define kSC__SCDeclInfo_TypeImprove 256
#define kSC__SCDeclInfo_UnknownConst 16
#define kSC__SCDeclInfo_UpgradeableContained 64
#define kSC__SCDeclInfo_UsedButAlteredBySomethingAheadInLoop 2097152
#define kSC__SCDeclInfo_UsedByCode 512
...
#define kSC__xC2xB5Param_Number 64
...
#define kSC__Pac_kContinue 254
#define kSC__Pac_kExit 255
...
#define kJB__Rec_NonFatal (JB_LUB[2101])
...
ASM SC_ASM_DivK_SpaceSet(ASM Self, uint Value);
...
ASMReg SC_Reg_Flip(ASMReg Self, ASMReg Bits);
...
ASMReg SC_ASMtmp__BitNot(ASMState* Self, Message* Exp, ASMReg Dest, int Mode);

ASMReg SC_ASMtmp__BoolNot(ASMState* Self, Message* Exp, ASMReg Dest, int Mode);
...
ASMReg SC_ASMtmp__DoGlobalSub(FatASM* Addr, int Add, Message* Exp);
...
ASMReg SC_ASMtmp__IncrOnAddr(ASMState* Self, Message* F, ASMReg Dest, int Mode, ASMReg Addr, int64 Amount);

ASMReg SC_ASMtmp__IncrSlowOnAddr(ASMState* Self, Message* F, ASMReg Dest, int Mode, ASMReg Addr, int64 Amount);
...
void SC_FatASM_ConstifyFloatDiv(FatASM* Self, ASMReg L, ASMReg R);

void SC_FatASM_ConstifyFloatMul(FatASM* Self, ASMReg L, ASMReg R);

void SC_FatASM_ConstifyFloatPlus(FatASM* Self, ASMReg L, ASMReg R);

void SC_FatASM_ConvertConst(FatASM* Self, uint /*DataTypeCode*/ Oldtype, uint /*DataTypeCode*/ Newtype);
...
void SC_FatASM_F64Set(FatASM* Self, Float64 Value);

Float64 SC_FatASM_F64(FatASM* Self);
...
ASMReg SC_Pac_DoAndOr(ASMState* Self, Message* Exp, ASMReg Dest, OpMode Opp);
...
Float64 SC_Pac_f(ASMState* Self, ASMReg R);
...
ASMReg SC_Pac_FloatDiv(ASMState* Self, ASMReg Dest, ASMReg L, ASMReg R, Message* Exp);
...
void SC_Pac_LoopClearUnreliableConsts(ASMState* Self);
...
void SC_Pac_MarkAvailableValues(ASMState* Self);
...
ASMReg SC_Pac_QuickFloatPlusSub(ASMState* Self, ASMReg Dest, ASMReg L, ASMReg R, Message* Exp);

ASMReg SC_Pac_QuickIntMul(ASMState* Self, ASMReg Dest, ASMReg L, ASMReg R, Message* Exp);

int SC_Pac_RegMap(ASMState* Self);

uint64* SC_Pac_RegPlace(ASMState* Self, int A);
...
FatASM* JB_Msg_DIVK(Message* Self, ASMReg R1, ASMReg R2, int Space, int Sh, int Add);
...
inline uint SC_FatASM_Index(FatASM* Self);
...
inline uint64* SC_Pac_GetConst(ASMState* Self, int RegNum);
...
inline uint64* SC_Pac_GetConst(ASMState* Self, int RegNum) {
	uint64* R = SC_Pac_RegPlace(Self, RegNum);
	if (R) {
		if ((!R[0]) == (!RegNum)) {
			return R;
		}
