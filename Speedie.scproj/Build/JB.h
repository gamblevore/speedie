...
ASMReg SC_ASMType__SimpleSet(ASMState* Self, Message* A, Message* B);
...
void SC_Hoi_Run(SC_Hoister* Self, Message* Exp, int Score);
...
void SC_Pac_InlineParameters(ASMState* Self, Message* Prms, ASMReg Dest, SCFunction* Fn);
